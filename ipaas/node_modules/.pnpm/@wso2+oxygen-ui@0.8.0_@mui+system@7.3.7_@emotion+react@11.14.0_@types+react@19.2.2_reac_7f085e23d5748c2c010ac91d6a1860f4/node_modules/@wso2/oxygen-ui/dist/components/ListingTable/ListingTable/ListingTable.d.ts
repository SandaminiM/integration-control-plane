...
import { ListingTableCellIcon, ListingTableRowActions, ListingTableEmptyState, ListingTableToolbar, ListingTableSortLabel, ListingTableDensityControl } from '../shared';
...
export declare function ListingTable({ variant, density, striped, bordered, children, sx, ...props }: ListingTableProps): ReactElement;
