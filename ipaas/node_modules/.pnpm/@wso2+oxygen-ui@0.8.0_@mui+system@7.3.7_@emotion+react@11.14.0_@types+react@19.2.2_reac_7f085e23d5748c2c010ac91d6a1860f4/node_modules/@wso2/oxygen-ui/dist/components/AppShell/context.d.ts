 ...
 */
export declare const AppShellContext: React.Context<UseAppShellReturn | undefined>;
/**
 ...
 * ```
 */
export declare const AppShellProvider: React.FC<React.PropsWithChildren<{
    value: UseAppShellReturn;
}>>;
/**
 ...
 * ```
 */
export declare const useAppShellContext: (componentName: string) => UseAppShellReturn;
