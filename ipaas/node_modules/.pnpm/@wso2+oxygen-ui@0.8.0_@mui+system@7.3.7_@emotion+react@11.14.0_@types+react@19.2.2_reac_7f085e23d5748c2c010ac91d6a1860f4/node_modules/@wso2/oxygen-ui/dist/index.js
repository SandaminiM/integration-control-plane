...
// inline-css-fonts:/home/runner/work/oxygen-ui/oxygen-ui/packages/oxygen-ui/src/fonts.css
(function() {
  if (typeof document !== "undefined") {
    const style = document.createElement("style");
    style.setAttribute("data-oxygen-fonts", "true");
    style.textContent = `/**
...
var package_default = {
  ...
  sideEffects: [
    ...
    "dist/styles/Themes/theme.css"
  ],
  scripts: {
    build: "pnpm clean && tsc -p tsconfig.json && node esbuild.config.js",
...
// src/styles/Themes/AcrylicBaseTheme.ts
import { extendTheme as extendTheme2 } from "@mui/material/styles";

// src/styles/Themes/OxygenThemeBase.ts
...
var pxToRem = (size) => `${size / 16}rem`;

// src/styles/Themes/OxygenThemeBase.ts
var OxygenUIPrimitives = {
  fontSize: 14,
  primaryColor: "#ff7300",
  secondaryColor: "#757575"
};
var OxygenThemeBase = extendTheme({
  cssVarPrefix: "oxygen",
  ...
  typography: {
    ...
    body2: {
      fontSize: pxToRem(OxygenUIPrimitives.fontSize - 1),
      // Will use by the labels in the components
      fontWeight: 400
    },
    button: {
      fontSize: pxToRem(OxygenUIPrimitives.fontSize),
...
var OxygenThemeBase_default = OxygenThemeBase;

// src/styles/Themes/AcrylicBaseTheme.ts
var AcrylicBaseTheme = extendTheme2(OxygenThemeBase_default, {
  colorSchemes: {
    light: {
      palette: {
        primary: {
    ...
    dark: {
      palette: {
        ...
        background: {
          ...
          paper: "#000000b8",
          acrylic: "#00000045"
          // More transparent version for Paper and Card components
        },
        text: {
          primary: "#efefef",
          secondary: "#D0D3E2"
...
var AcrylicBaseTheme_default = AcrylicBaseTheme;

// src/styles/Themes/AcrylicOrangeTheme.ts
import { extendTheme as extendTheme3 } from "@mui/material/styles";
var AcrylicOrangeTheme = extendTheme3(AcrylicBaseTheme_default, {
  components: {
    MuiCssBaseline: {
      styleOverrides: {
...
var AcrylicOrangeTheme_default = AcrylicOrangeTheme;

// src/styles/Themes/AcrylicPurpleTheme.ts
import { extendTheme as extendTheme4 } from "@mui/material/styles";
var AcrylicPurpleThemeBase = extendTheme4(AcrylicBaseTheme_default, {
  colorSchemes: {
    light: {
      palette: {
        primary: {
...
var AcrylicPurpleTheme = AcrylicPurpleThemeBase;
var AcrylicPurpleTheme_default = AcrylicPurpleTheme;

// src/styles/Themes/ChoreoTheme.ts
import { extendTheme as extendTheme5 } from "@mui/material/styles";
var ChoreoThemeBase = extendTheme5(OxygenThemeBase_default, {
  shape: {
    borderRadius: 8
  },
  colorSchemes: {
...
var ChoreoTheme = ChoreoThemeBase;
var ChoreoTheme_default = ChoreoTheme;

// src/styles/Themes/ClassicTheme.ts
import { extendTheme as extendTheme6 } from "@mui/material/styles";
var ClassicTheme = extendTheme6(OxygenThemeBase_default, {
  shadows: Array(25).fill("none")
});
var ClassicTheme_default = ClassicTheme;

// src/styles/Themes/HighContrastTheme.ts
import { extendTheme as extendTheme7 } from "@mui/material/styles";
var HighContrastThemeBase = extendTheme7(OxygenThemeBase_default, {
  colorSchemes: {
    light: {
      palette: {
        primary: {
...
var HighContrastTheme = HighContrastThemeBase;
...
var HighContrastTheme_default = HighContrastTheme;

// src/styles/Themes/PaleBaseTheme.ts
import { extendTheme as extendTheme8 } from "@mui/material/styles";
var PaleBaseTheme = extendTheme8(OxygenThemeBase_default, {
  shape: {
    borderRadius: 8
  },
  components: {
...
var PaleBaseTheme_default = PaleBaseTheme;

// src/styles/Themes/PaleGray.ts
import { extendTheme as extendTheme9 } from "@mui/material/styles";
var PaleGrayTheme = extendTheme9(PaleBaseTheme_default, {
  colorSchemes: {
    light: {
      palette: {
        primary: {
...
var PaleGray_default = PaleGrayTheme;

// src/styles/Themes/PaleIndigo.ts
import { extendTheme as extendTheme10 } from "@mui/material/styles";
var PaleIndigoTheme = extendTheme10(PaleBaseTheme_default, {
  colorSchemes: {
    light: {
      palette: {
        primary: {
...
var PaleIndigo_default = PaleIndigoTheme;
...
var THEME_STORAGE_KEY = "oxygen-theme";
var defaultThemes = [
  {
    key: "default",
    label: "Default",
    theme: AcrylicBaseTheme_default
  },
  {
    key: "acrylicOrange",
    label: "Acrylic Orange",
    theme: AcrylicOrangeTheme_default
  },
  {
    key: "acrylicPurple",
    label: "Acrylic Purple",
    theme: AcrylicPurpleTheme_default
  }
];
var ThemeSwitcherContext = createContext(null);
...
function OxygenUIThemeProvider({
  children,
  theme,
  themes,
  initialTheme
  ...
  const [currentThemeKey, setCurrentThemeKey] = useState(() => {
    ...
    return initialTheme || ((_a2 = themeOptions[0]) == null ? void 0 : _a2.key) || "default";
  });
  useEffect(() => {
    if (typeof window !== "undefined" && useThemeSwitching) {
      try {
  ...
  if (useThemeSwitching) {
    resolvedTheme = ((_a = themeOptions.find((t) => t.key === currentThemeKey)) == null ? void 0 : _a.theme) || ((_b = themeOptions[0]) == null ? void 0 : _b.theme);
  } else {
    resolvedTheme = theme || AcrylicBaseTheme_default;
  }
  ...
  const isActive = (themeKey) => currentThemeKey === themeKey;
  const contextValue = {
    theme: resolvedTheme,
  ...
  const content = /* @__PURE__ */ jsx(StyledEngineProvider, { injectFirst: true, children: /* @__PURE__ */ jsxs(ThemeProvider, { theme: resolvedTheme, children: [
    /* @__PURE__ */ jsx(CssBaseline, { enableColorScheme: true }),
    children
  ] }) });
  if (useThemeSwitching) {
    return /* @__PURE__ */ jsx(ThemeSwitcherContext.Provider, { value: contextValue, children: content });
  }
  return content;
}
...
var CodeBlock = ({
  ...
  const colors2 = (isDark ? (_b = (_a = theme.vars) == null ? void 0 : _a.syntax) == null ? void 0 : _b.dark : (_d = (_c = theme.vars) == null ? void 0 : _c.syntax) == null ? void 0 : _d.light) || defaultColors;
  return /* @__PURE__ */ jsx2(
    Box,
    {
      sx: __spreadValues({
        ...
        borderRadius: 1,
        overflow: "hidden",
        border: `1px solid ${((_e = theme.vars) == null ? void 0 : _e.palette.divider) || theme.palette.divider}`,
        mb: 2,
        "& pre": {
          margin: 0,
          padding: 2,
        ...
        "& .token.property, & .token.tag, & .token.boolean, & .token.constant, & .token.symbol, & .token.deleted": {
          color: colors2.keyword
        },
        "& .token.selector, & .token.attr-name, & .token.string, & .token.char, & .token.builtin, & .token.inserted": {
          color: colors2.string
        },
        "& .token.operator, & .token.entity, & .token.url": {
          color: colors2.operator
        },
        "& .token.atrule, & .token.attr-value, & .token.keyword": {
          color: colors2.keyword
        },
        "& .token.function, & .token.class-name": {
          color: colors2.function
        },
        ...
        "& .line-numbers-rows": {
          borderRight: `1px solid ${((_f = theme.vars) == null ? void 0 : _f.palette.divider) || theme.palette.divider}`
        }
      }),
      children: /* @__PURE__ */ jsx2(
        Box,
        {
          ...
          children: /* @__PURE__ */ jsx2("code", { className: `language-${language}`, children: code })
        }
      )
    }
  );
...
function ColorSchemeImage(_a) {
  var _b = _a, { src, alt, width = 16, height = 16 } = _b, rest = __objRest(_b, ["src", "alt", "width", "height"]);
  ...
  const imageSrc = actualMode === "dark" ? src.dark : src.light;
  let imageAlt;
  ...
  return /* @__PURE__ */ jsx3(Box2, __spreadValues({ component: "img", src: imageSrc, alt: imageAlt, width, height }, rest));
}
...
var ColorSchemeToggle = (_a) => {
  ...
  const { mode, setMode } = useColorScheme2();
  if (!mode) {
    return null;
  }
  const nextMode = (currentMode2) => {
    if (currentMode2 === "light") return "dark";
    if (currentMode2 === "dark") return "system";
    return "light";
  };
  const currentMode = mode != null ? mode : "system";
  const ColorSchemeIcon = () => {
    switch (currentMode) {
      case "light":
        return lightModeIcon != null ? lightModeIcon : /* @__PURE__ */ jsx4(Sun, {});
      case "dark":
        return darkModeIcon != null ? darkModeIcon : /* @__PURE__ */ jsx4(Moon, {});
      default:
        return systemModeIcon != null ? systemModeIcon : /* @__PURE__ */ jsx4(Monitor, {});
    }
  };
  return /* @__PURE__ */ jsx4(Tooltip, { title: `${currentMode.charAt(0).toUpperCase()}${currentMode.slice(1)} Mode`, children: /* @__PURE__ */ jsx4(IconButton, __spreadProps(__spreadValues({}, buttonProps), { onClick: () => setMode(nextMode(currentMode)), children: /* @__PURE__ */ jsx4(ColorSchemeIcon, {}) })) });
};
var ColorSchemeToggle_default = ColorSchemeToggle;

// src/components/ComplexSelect/ComplexSelect.tsx
...
// src/components/ComplexSelect/ComplexSelectListHeader.tsx
import MuiListSubheader from "@mui/material/ListSubheader";
import { styled } from "@mui/material/styles";
import { jsx as jsx5 } from "react/jsx-runtime";
var StyledListSubheader = styled(MuiListSubheader, {
  name: "MuiComplexSelectListHeader",
  slot: "Root"
})(() => ({
  paddingTop: 0
}));
function ComplexSelectListHeader(_a) {
  var _b = _a, { children } = _b, props = __objRest(_b, ["children"]);
  return /* @__PURE__ */ jsx5(StyledListSubheader, __spreadProps(__spreadValues({}, props), { children }));
}
ComplexSelectListHeader.displayName = "ComplexSelect.ListHeader";
var ComplexSelectListHeader_default = ComplexSelectListHeader;

// src/components/ComplexSelect/ComplexSelectMenuItem.tsx
import MuiMenuItem from "@mui/material/MenuItem";
import { styled as styled4 } from "@mui/material/styles";

// src/components/ComplexSelect/ComplexSelectMenuItemAvatar.tsx
import { styled as styled2 } from "@mui/material/styles";
import MuiListItemAvatar from "@mui/material/ListItemAvatar";
import MuiAvatar from "@mui/material/Avatar";
import { jsx as jsx6 } from "react/jsx-runtime";
var StyledAvatar = styled2(MuiAvatar, {
...
var StyledListItemAvatar = styled2(MuiListItemAvatar, {
  name: "MuiComplexSelectMenuItemAvatar",
  slot: "Root"
})({
  minWidth: 0,
...
function ComplexSelectMenuItemAvatar(_a) {
  var _b = _a, { children } = _b, props = __objRest(_b, ["children"]);
  return /* @__PURE__ */ jsx6(StyledListItemAvatar, { children: /* @__PURE__ */ jsx6(StyledAvatar, __spreadProps(__spreadValues({}, props), { children })) });
}
ComplexSelectMenuItemAvatar.displayName = "ComplexSelect.MenuItemAvatar";
var ComplexSelectMenuItemAvatar_default = ComplexSelectMenuItemAvatar;

// src/components/ComplexSelect/ComplexSelectMenuItemText.tsx
import MuiListItemText from "@mui/material/ListItemText";
import { jsx as jsx7 } from "react/jsx-runtime";
function ComplexSelectMenuItemText(_a) {
  var _b = _a, { primary, secondary } = _b, props = __objRest(_b, ["primary", "secondary"]);
...
var ComplexSelectMenuItemText_default = ComplexSelectMenuItemText;

// src/components/ComplexSelect/ComplexSelectMenuItemIcon.tsx
import MuiListItemIcon from "@mui/material/ListItemIcon";
import { styled as styled3 } from "@mui/material/styles";
import { jsx as jsx8 } from "react/jsx-runtime";
var StyledListItemIcon = styled3(MuiListItemIcon, {
  name: "MuiComplexSelectMenuItemIcon",
  slot: "Root"
})(() => ({
  minWidth: "36px"
}));
function ComplexSelectMenuItemIcon(_a) {
  var _b = _a, { children } = _b, props = __objRest(_b, ["children"]);
  return /* @__PURE__ */ jsx8(StyledListItemIcon, __spreadProps(__spreadValues({}, props), { children }));
}
ComplexSelectMenuItemIcon.displayName = "ComplexSelect.MenuItemIcon";
var ComplexSelectMenuItemIcon_default = ComplexSelectMenuItemIcon;

// src/components/ComplexSelect/ComplexSelectMenuItem.tsx
import { jsx as jsx9 } from "react/jsx-runtime";
var StyledMenuItem = styled4(MuiMenuItem, {
  name: "MuiComplexSelectMenuItem",
  slot: "Root"
})(({ theme }) => ({
  "&:hover": {
    backgroundColor: theme.vars ? `rgba(${theme.vars.palette.primary.mainChannel} / 0.08)` : theme.palette.action.hover
  },
  "&.Mui-selected": {
    backgroundColor: theme.vars ? `rgba(${theme.vars.palette.primary.mainChannel} / 0.12)` : theme.palette.action.selected,
    "&:hover": {
      backgroundColor: theme.vars ? `rgba(${theme.vars.palette.primary.mainChannel} / 0.16)` : theme.palette.action.selected
    }
  }
}));
var ComplexSelectMenuItem = Object.assign(
  (_a) => {
    var _b = _a, { children } = _b, props = __objRest(_b, ["children"]);
    return /* @__PURE__ */ jsx9(StyledMenuItem, __spreadProps(__spreadValues({}, props), { children }));
  },
  {
    Avatar: ComplexSelectMenuItemAvatar_default,
    Text: ComplexSelectMenuItemText_default,
    Icon: ComplexSelectMenuItemIcon_default
  }
);
StyledMenuItem.displayName = "ComplexSelect.MenuItem";
var ComplexSelectMenuItem_default = ComplexSelectMenuItem;

// src/components/ComplexSelect/ComplexSelectDivider.tsx
import MuiDivider from "@mui/material/Divider";
import { styled as styled5 } from "@mui/material/styles";
import { jsx as jsx10 } from "react/jsx-runtime";
var StyledDivider = styled5(MuiDivider, {
...
function ComplexSelectDivider(_a) {
  var props = __objRest(_a, []);
  return /* @__PURE__ */ jsx10(StyledDivider, __spreadValues({}, props));
}
ComplexSelectDivider.displayName = "ComplexSelect.Divider";
var ComplexSelectDivider_default = ComplexSelectDivider;

// src/components/ComplexSelect/ComplexSelect.tsx
import { Fragment, jsx as jsx11, jsxs as jsxs2 } from "react/jsx-runtime";
var StyledSelect = styled6(MuiSelect, {
...
var InsideLabelText = styled6(MuiTypography, {
  name: "MuiComplexSelect",
  slot: "InsideLabel"
})(({ theme }) => {
  var _a;
  return {
    fontSize: theme.typography.caption.fontSize,
    color: ((_a = theme.vars) == null ? void 0 : _a.palette.text.secondary) || theme.palette.text.secondary,
    opacity: 0.7,
    display: "block",
    lineHeight: 1.2,
...
var StyledFormControl = styled6(MuiFormControl, {
  name: "MuiComplexSelect",
  slot: "FormControl"
})(() => ({
  minWidth: 120
}));
var StyledInputLabel = styled6(MuiInputLabel, {
  name: "MuiComplexSelect",
  slot: "InputLabel",
  shouldForwardProp: (prop) => prop !== "labelAnchor"
})(({ theme, labelAnchor = "inside" }) => {
  var _a, _b;
  return __spreadValues({}, labelAnchor === "outside" && {
    position: "relative",
    transform: "none",
    marginBottom: theme.spacing(1),
    color: ((_a = theme.vars) == null ? void 0 : _a.palette.text.primary) || theme.palette.text.primary,
    fontSize: theme.typography.body2.fontSize,
    fontWeight: theme.typography.fontWeightMedium,
    "&.Mui-focused": {
      color: ((_b = theme.vars) == null ? void 0 : _b.palette.text.primary) || theme.palette.text.primary
    }
  });
});
function ComplexSelect(_a) {
  var _b = _a, { children, sx, label, labelId, labelAnchor = "inside" } = _b, props = __objRest(_b, ["children", "sx", "label", "labelId", "labelAnchor"]);
  const injectLabelIntoContent = (content) => {
    if (!label || labelAnchor !== "inside") return content;
    const processChildren = (node) => {
      if (!isValidElement(node)) return node;
      if (node.type && typeof node.type === "function") {
        const nodeProps2 = node.props;
        if (nodeProps2.primary) {
          return __spreadProps(__spreadValues({}, node), {
            props: __spreadProps(__spreadValues({}, nodeProps2), {
              primary: /* @__PURE__ */ jsxs2(Fragment, { children: [
                /* @__PURE__ */ jsx11(InsideLabelText, { children: label }),
                nodeProps2.primary
              ] }),
      ...
      if (nodeProps.children) {
        return __spreadProps(__spreadValues({}, node), {
          props: __spreadProps(__spreadValues({}, nodeProps), {
  ...
  const findMenuItemContent = (selected) => {
    let content = selected;
    const findInChildren = (childNodes) => {
  ...
  const renderInsideValue = labelAnchor === "inside" && label ? (selected) => findMenuItemContent(selected) : props.renderValue;
  const defaultMenuProps = __spreadValues({
    anchorOrigin: {
      vertical: "bottom",
      horizontal: "left"
    },
  ...
  const selectContent = /* @__PURE__ */ jsx11(
    StyledSelect,
  ...
  if (label) {
    ...
    return /* @__PURE__ */ jsxs2(StyledFormControl, { fullWidth: props.fullWidth, children: [
      labelAnchor !== "inside" && /* @__PURE__ */ jsx11(
        StyledInputLabel,
        {
          id: generatedLabelId,
          labelAnchor,
      ...
      /* @__PURE__ */ jsx11(
        StyledSelect,
        __spreadProps(__spreadValues({}, props), {
          label: labelAnchor === "border" ? label : void 0,
...
var ComplexSelectCompound = Object.assign(ComplexSelect, {
  ListHeader: ComplexSelectListHeader_default,
  MenuItem: ComplexSelectMenuItem_default,
  Divider: ComplexSelectDivider_default
});
var ComplexSelect_default = ComplexSelectCompound;
...
var PageContentRoot = styled7(Box3, {
  name: "MuiPageContent",
  slot: "Root"
})(() => ({
  width: "100%",
...
var PageContentInner = styled7(Box3, {
  name: "MuiPageContent",
  slot: "Inner",
  shouldForwardProp: (prop) => prop !== "maxWidth" && prop !== "centered" && prop !== "fullWidth" && prop !== "noPadding"
})(({ theme, maxWidth = "1400px", centered = true, fullWidth = false, noPadding = false }) => __spreadValues(__spreadValues(__spreadValues({
  width: "100%"
}, !fullWidth && { maxWidth }), centered && { marginLeft: "auto", marginRight: "auto" }), !noPadding && { padding: theme.spacing(8) }));
var PageContent = (_a) => {
  var _b = _a, {
    children,
    maxWidth,
  ...
  return /* @__PURE__ */ jsx12(PageContentRoot, { children: /* @__PURE__ */ jsx12(
    PageContentInner,
...
var PageTitleHeader = (_a) => {
  var _b = _a, { children, variant = "h1" } = _b, props = __objRest(_b, ["children", "variant"]);
  return /* @__PURE__ */ jsx13(PageTitleHeaderStyled, __spreadProps(__spreadValues({ variant }, props), { children }));
};
PageTitleHeader.displayName = "PageTitle.Header";
var PageTitleHeader_default = PageTitleHeader;

// src/components/PageTitle/PageTitleSubHeader.tsx
import { styled as styled9 } from "@mui/material/styles";
import Typography2 from "@mui/material/Typography";
import { jsx as jsx14 } from "react/jsx-runtime";
var PageTitleSubHeaderStyled = styled9(Typography2, {
  name: "MuiPageTitle",
  slot: "SubHeader"
})(({ theme }) => {
  var _a;
...
var PageTitleSubHeader = (_a) => {
  var _b = _a, { children, variant = "body2" } = _b, props = __objRest(_b, ["children", "variant"]);
  return /* @__PURE__ */ jsx14(PageTitleSubHeaderStyled, __spreadProps(__spreadValues({ variant }, props), { children }));
};
PageTitleSubHeader.displayName = "PageTitle.SubHeader";
var PageTitleSubHeader_default = PageTitleSubHeader;

// src/components/PageTitle/PageTitleAvatar.tsx
import { styled as styled10 } from "@mui/material/styles";
import Avatar from "@mui/material/Avatar";
import { jsx as jsx15 } from "react/jsx-runtime";
var PageTitleAvatarStyled = styled10(Avatar, {
  name: "MuiPageTitle",
  slot: "Avatar"
})(({ theme }) => ({
  width: 55,
...
var PageTitleAvatar = (_a) => {
  var _b = _a, { children } = _b, props = __objRest(_b, ["children"]);
  return /* @__PURE__ */ jsx15(PageTitleAvatarStyled, __spreadProps(__spreadValues({}, props), { children }));
};
PageTitleAvatar.displayName = "PageTitle.Avatar";
var PageTitleAvatar_default = PageTitleAvatar;

// src/components/PageTitle/PageTitleLink.tsx
import { styled as styled11 } from "@mui/material/styles";
import Link from "@mui/material/Link";
import Box4 from "@mui/material/Box";
import { jsx as jsx16, jsxs as jsxs3 } from "react/jsx-runtime";
var PageTitleLinkStyled = styled11(Link, {
  name: "MuiPageTitle",
  slot: "Link"
})(({ theme }) => ({
  fontSize: "0.875rem",
...
var PageTitleLink = (_a) => {
  var _b = _a, { children, icon } = _b, props = __objRest(_b, ["children", "icon"]);
  return /* @__PURE__ */ jsxs3(PageTitleLinkStyled, __spreadProps(__spreadValues({}, props), { children: [
    icon && /* @__PURE__ */ jsx16(Box4, { component: "span", sx: { display: "inline-flex", alignItems: "center", fontSize: "1rem" }, children: icon }),
    children
  ] }));
};
PageTitleLink.displayName = "PageTitle.Link";
var PageTitleLink_default = PageTitleLink;

// src/components/PageTitle/PageTitleActions.tsx
import { styled as styled12 } from "@mui/material/styles";
import { jsx as jsx17 } from "react/jsx-runtime";
var PageTitleActionsRoot = styled12("div", {
  name: "MuiPageTitle",
  slot: "Actions"
})(({ theme }) => ({
  display: "flex",
...
var PageTitleActions = (_a) => {
  var _b = _a, { children } = _b, props = __objRest(_b, ["children"]);
  return /* @__PURE__ */ jsx17(PageTitleActionsRoot, __spreadProps(__spreadValues({}, props), { children }));
};
PageTitleActions.displayName = "PageTitle.Actions";
var PageTitleActions_default = PageTitleActions;

// src/components/PageTitle/PageTitleBackButton.tsx
...
var PageTitleBackButtonRoot = styled13("div", {
  name: "MuiPageTitle",
  slot: "BackButton"
})();
var PageTitleBackButton = (_a) => {
  var _b = _a, {
    children = "Back",
    component: Component
  } = _b, props = __objRest(_b, [
  ...
  const button = /* @__PURE__ */ jsxs4(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        /* @__PURE__ */ jsx18(ArrowLeft, { size: 20 }),
        /* @__PURE__ */ jsx18(Typography3, { variant: "body2", children })
      ]
    })
  );
  if (React3.isValidElement(Component)) {
    return /* @__PURE__ */ jsx18(PageTitleBackButtonRoot, { children: React3.cloneElement(
      Component,
  ...
  if (Component) {
    ...
    return /* @__PURE__ */ jsx18(PageTitleBackButtonRoot, { children: /* @__PURE__ */ jsx18(WrapperComponent, { style: { textDecoration: "none" }, children: button }) });
  }
  return /* @__PURE__ */ jsx18(PageTitleBackButtonRoot, { children: button });
};
PageTitleBackButton.displayName = "PageTitle.BackButton";
var PageTitleBackButton_default = PageTitleBackButton;

// src/components/PageTitle/PageTitle.tsx
import { jsx as jsx19, jsxs as jsxs5 } from "react/jsx-runtime";
var PageTitleRoot = styled14("div", {
  name: "MuiPageTitle",
  slot: "Root"
})(({ theme }) => ({
...
var PageTitleRow1 = styled14("div", {
  name: "MuiPageTitle",
  slot: "Row1"
})();
var PageTitleRow2 = styled14("div", {
  name: "MuiPageTitle",
  slot: "Row2"
})(({ theme }) => ({
  display: "flex",
...
var PageTitleColumnLeft = styled14("div", {
  name: "MuiPageTitle",
  slot: "ColumnLeft"
})(({ theme }) => ({
  display: "flex",
...
var PageTitleColumn1 = styled14("div", {
  name: "MuiPageTitle",
  slot: "Column1"
})();
var PageTitleColumn2 = styled14("div", {
  name: "MuiPageTitle",
  slot: "Column2"
})(({ theme }) => ({
  display: "flex",
...
var PageTitleColumnRight = styled14("div", {
  name: "MuiPageTitle",
  slot: "ColumnRight"
})();
var PageTitle = (_a) => {
  var _b = _a, { children, sx } = _b, props = __objRest(_b, ["children", "sx"]);
  const childrenArray = React4.Children.toArray(children);
  const avatar = childrenArray.find(
    (child) => React4.isValidElement(child) && child.type === PageTitleAvatar_default
  );
  const actions = childrenArray.find(
    (child) => React4.isValidElement(child) && child.type === PageTitleActions_default
  );
  let backButtonElement = null;
  childrenArray.forEach((child) => {
    if (React4.isValidElement(child)) {
      if (child.type === PageTitleBackButton_default) {
        backButtonElement = child;
      }
      if (child.props && typeof child.props === "object" && "children" in child.props && React4.isValidElement(child.props.children)) {
        if (child.props.children.type === PageTitleBackButton_default) {
          backButtonElement = child;
        }
      }
    }
  ...
  const otherChildren = childrenArray.filter(
    (child) => {
      ...
      if (child.type === PageTitleAvatar_default || child.type === PageTitleActions_default || child.type === PageTitleBackButton_default) {
        return false;
      }
      if (child.props && typeof child.props === "object" && "children" in child.props && React4.isValidElement(child.props.children)) {
        const childrenProp = child.props.children;
        if (React4.isValidElement(childrenProp) && childrenProp.type === PageTitleBackButton_default) {
          return false;
        }
      }
      return true;
  ...
  return /* @__PURE__ */ jsxs5(PageTitleRoot, __spreadProps(__spreadValues({ sx }, props), { children: [
    backButtonElement && /* @__PURE__ */ jsx19(PageTitleRow1, { children: backButtonElement }),
    /* @__PURE__ */ jsxs5(PageTitleRow2, { children: [
      /* @__PURE__ */ jsxs5(PageTitleColumnLeft, { children: [
        /* @__PURE__ */ jsx19(PageTitleColumn1, { children: avatar }),
        /* @__PURE__ */ jsx19(PageTitleColumn2, { children: otherChildren })
      ] }),
      /* @__PURE__ */ jsx19(PageTitleColumnRight, { children: actions })
    ] })
  ] }));
};
PageTitle.Avatar = PageTitleAvatar_default;
PageTitle.Header = PageTitleHeader_default;
PageTitle.SubHeader = PageTitleSubHeader_default;
PageTitle.Link = PageTitleLink_default;
PageTitle.Actions = PageTitleActions_default;
PageTitle.BackButton = PageTitleBackButton_default;
PageTitle.Link = PageTitleLink_default;
PageTitle.displayName = "PageTitle";
var PageTitle_default = PageTitle;

// src/components/StatCard/StatCard.tsx
import { Card, CardContent, Box as Box5, Typography as Typography4 } from "@mui/material";
...
var StatCard = (_a) => {
  ...
  return /* @__PURE__ */ jsx20(Card, __spreadProps(__spreadValues({ variant: "outlined" }, props), { children: /* @__PURE__ */ jsx20(CardContent, { children: /* @__PURE__ */ jsxs6(Box5, { sx: { display: "flex", alignItems: "center", gap: 2 }, children: [
    icon && /* @__PURE__ */ jsx20(Box5, { sx: { color: (theme) => theme.palette[iconColor].main, display: "flex", alignItems: "center" }, children: icon }),
    /* @__PURE__ */ jsxs6(Box5, { children: [
      /* @__PURE__ */ jsx20(Typography4, { variant: "h5", children: value }),
      /* @__PURE__ */ jsx20(Typography4, { variant: "body2", color: "text.secondary", children: label })
    ] })
  ] }) }) }));
};
...
// src/components/ThemeSwitcher/ThemeSelect.tsx
...
function ThemeSelect({
  ...
  return /* @__PURE__ */ jsxs7(FormControl, { size, variant, sx: __spreadValues({ minWidth: 120 }, sx), children: [
    showLabel && /* @__PURE__ */ jsx21(InputLabel, { id: "theme-select-label", children: label }),
    /* @__PURE__ */ jsx21(
      Select,
      {
        labelId: showLabel ? "theme-select-label" : void 0,
        value: currentTheme,
        onChange: handleChange,
        label: showLabel ? label : void 0,
        children: themes.map((themeOption) => /* @__PURE__ */ jsx21(MenuItem, { value: themeOption.key, children: themeOption.label }, themeOption.key))
      }
    )
  ] });
}
...
function ThemeSwitcher({
  ...
  if (children) {
    return /* @__PURE__ */ jsx22(Fragment2, { children: children(themeSwitcherContext) });
  }
...
// src/components/SearchBar/SearchBarWithAdvancedFilter.tsx
...
function SearchBarWithAdvancedFilter(_a) {
  var _b = _a, {
    value,
    onChange,
    advancedFilter,
  ...
  const handleAttrChange = (e) => {
    onAdvancedFilterChange(__spreadProps(__spreadValues({}, advancedFilter), { attribute: e.target.value }));
  };
  const handleCondChange = (e, child) => {
    onAdvancedFilterChange(__spreadProps(__spreadValues({}, advancedFilter), { condition: e.target.value }));
  };
  const handleFilterValueChange = (e) => {
    onAdvancedFilterChange(__spreadProps(__spreadValues({}, advancedFilter), { value: e.target.value }));
  };
  const handleAdvancedSearch = () => {
    onAdvancedSearch == null ? void 0 : onAdvancedSearch({
      searchText: value,
  ...
  const popoverId = open ? "advanced-search-popover" : void 0;
  return /* @__PURE__ */ jsxs8(Fragment3, { children: [
    /* @__PURE__ */ jsx23(
      ...
      __spreadProps(__spreadValues({}, props), {
        ...
        InputProps: {
          startAdornment: /* @__PURE__ */ jsx23(InputAdornment, { position: "start", children: /* @__PURE__ */ jsx23(Search, { fontSize: "small" }) }),
          endAdornment: /* @__PURE__ */ jsx23(InputAdornment, { position: "end", sx: { m: 0 }, children: /* @__PURE__ */ jsxs8(Box6, { sx: { display: "flex", alignItems: "center", height: "100%" }, children: [
            /* @__PURE__ */ jsx23(Divider, { orientation: "vertical", flexItem: true, sx: { mx: 0.5 } }),
            /* @__PURE__ */ jsx23(
              IconButton2,
              {
                ...
                size: "small",
                sx: { mx: 0.5 },
                children: /* @__PURE__ */ jsx23(ListFilter, { fontSize: "tiny" })
              }
            )
          ] }) })
        }
    ...
    /* @__PURE__ */ jsxs8(
      Popover,
      {
        ...
        children: [
          /* @__PURE__ */ jsx23(Typography5, { variant: "subtitle2", sx: { fontWeight: 600 }, children: "Advanced search" }),
          /* @__PURE__ */ jsx23(Divider, { sx: { my: 1 } }),
          /* @__PURE__ */ jsxs8(Stack, { spacing: 2, marginTop: 2, children: [
            /* @__PURE__ */ jsxs8(FormControl2, { fullWidth: true, size: "small", children: [
              /* @__PURE__ */ jsxs8(InputLabel2, { id: "adv-filter-attribute-label", children: [
                "Filter attribute",
                " ",
                /* @__PURE__ */ jsx23(Box6, { component: "span", sx: { color: "error.main" }, children: "*" })
              ] }),
              /* @__PURE__ */ jsx23(
                Select2,
                {
                  ...
                  children: attributeOptions.map((opt) => /* @__PURE__ */ jsx23(MenuItem2, { value: opt.value, children: opt.label }, opt.value))
                }
              )
            ] }),
            /* @__PURE__ */ jsxs8(Box6, { sx: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 2 }, children: [
              /* @__PURE__ */ jsxs8(FormControl2, { fullWidth: true, size: "small", children: [
                /* @__PURE__ */ jsxs8(InputLabel2, { id: "adv-filter-condition-label", children: [
                  "Filter condition",
                  " ",
                  /* @__PURE__ */ jsx23(Box6, { component: "span", sx: { color: "error.main" }, children: "*" })
                ] }),
                /* @__PURE__ */ jsx23(
                  Select2,
                  {
                    ...
                    children: conditionOptions.map((opt) => /* @__PURE__ */ jsx23(MenuItem2, { value: opt.value, children: opt.label }, opt.value))
                  }
                )
              ] }),
              /* @__PURE__ */ jsx23(
            ...
            /* @__PURE__ */ jsx23(Box6, { sx: { display: "flex", justifyContent: "flex-start" }, children: /* @__PURE__ */ jsx23(
              Button2,
              {
                variant: "contained",
                onClick: handleAdvancedSearch,
                disabled: !advancedFilter.attribute || !advancedFilter.condition || !advancedFilter.value,
...
var SearchBarWithAdvancedFilter_default = SearchBarWithAdvancedFilter;

// src/components/SearchBar/SearchBar.tsx
import TextField2 from "@mui/material/TextField";
import InputAdornment2 from "@mui/material/InputAdornment";
import { Search as Search2 } from "@wso2/oxygen-ui-icons-react";
...
function SearchBar(_a) {
  ...
  return /* @__PURE__ */ jsx24(
    ...
    __spreadProps(__spreadValues({}, props), {
      ...
      slotProps: {
        input: {
          startAdornment: /* @__PURE__ */ jsx24(InputAdornment2, { position: "start", children: /* @__PURE__ */ jsx24(Search2, { fontSize: "small" }) })
        }
      }
    })
  );
...
// src/components/Header/context.ts
import * as React6 from "react";
var HeaderContext = React6.createContext(null);
var useHeader = () => {
  const context = React6.useContext(HeaderContext);
  if (!context) {
...
// src/components/Header/HeaderToggle.tsx
...
// src/components/AppShell/context.tsx
import * as React7 from "react";
import { jsx as jsx25 } from "react/jsx-runtime";
var AppShellContext = React7.createContext(void 0);
var AppShellProvider = ({
  children,
  value
}) => {
  return /* @__PURE__ */ jsx25(AppShellContext.Provider, { value, children });
};
AppShellProvider.displayName = "AppShellProvider";

// src/components/Header/HeaderToggle.tsx
import { jsx as jsx26 } from "react/jsx-runtime";
var HeaderToggleRoot = styled15(IconButton3, {
  name: "MuiHeader",
  slot: "Toggle"
})(({ theme }) => ({
  color: (theme.vars || theme).palette.text.secondary
...
var HeaderToggle = ({
  ...
  var _a, _b;
  const appShellContext = React8.useContext(AppShellContext);
  const collapsed = (_a = collapsedProp != null ? collapsedProp : appShellContext == null ? void 0 : appShellContext.state.sidebarCollapsed) != null ? _a : false;
  const onToggle = (_b = onToggleProp != null ? onToggleProp : appShellContext == null ? void 0 : appShellContext.actions.toggleSidebar) != null ? _b : (() => {
  });
  return /* @__PURE__ */ jsx26(Tooltip2, { title: collapsed ? expandLabel : collapseLabel, children: /* @__PURE__ */ jsx26(HeaderToggleRoot, { onClick: onToggle, size: "small", sx, children: collapsed ? expandIcon || /* @__PURE__ */ jsx26(Menu, { size: 20 }) : collapseIcon || /* @__PURE__ */ jsx26(Menu, { size: 20 }) }) });
};
...
// src/components/Header/HeaderBrandLogo.tsx
import Box7 from "@mui/material/Box";
import { styled as styled16 } from "@mui/material/styles";
import { jsx as jsx27 } from "react/jsx-runtime";
var HeaderBrandLogoRoot = styled16(Box7, {
  name: "MuiHeader",
  slot: "BrandLogo"
})({
  display: "flex",
...
var HeaderBrandTitle = ({
  children,
  sx
}) => {
  return /* @__PURE__ */ jsx28(HeaderBrandTitleRoot, { variant: "h6", component: "div", sx, children });
};
HeaderBrandTitle.displayName = "HeaderBrandTitle";

// src/components/Header/HeaderBrand.tsx
import { jsx as jsx29 } from "react/jsx-runtime";
var HeaderBrandRoot = styled18(Box8, {
  name: "MuiHeader",
  slot: "Brand",
...
var HeaderBrand = ({
  ...
  return /* @__PURE__ */ jsx29(HeaderBrandRoot, { onClick, clickable: !!onClick, sx, children });
};
HeaderBrand.displayName = "HeaderBrand";

// src/components/Header/HeaderSwitchers.tsx
...
var HeaderSwitchersRoot = styled19(Box9, {
  name: "MuiHeader",
  slot: "Switchers"
})(({ theme }) => ({
  display: "none",
...
var HeaderSwitchersDivider = styled19(Divider2, {
  name: "MuiHeader",
...
var HeaderSwitchers = ({
  ...
  return /* @__PURE__ */ jsxs9(HeaderSwitchersRoot, { sx, children: [
    showDivider && /* @__PURE__ */ jsx30(HeaderSwitchersDivider, { orientation: "vertical", flexItem: true }),
    children
  ] });
};
...
var HeaderActionsRoot = styled20(Box10, {
  name: "MuiHeader",
  slot: "Actions"
})(({ theme }) => ({
  display: "flex",
...
var HeaderActions = ({
  ...
  return /* @__PURE__ */ jsx31(HeaderActionsRoot, { sx, children });
};

// src/components/Header/Header.tsx
import { jsx as jsx32 } from "react/jsx-runtime";
var HeaderRootStyled = styled21(AppBar, {
  name: "MuiHeader",
  slot: "Root"
})(({ theme }) => ({
  backgroundColor: (theme.vars || theme).palette.background.paper,
...
var HeaderToolbar = styled21(Toolbar, {
  name: "MuiHeader",
  slot: "Toolbar"
})(({ theme }) => ({
  gap: theme.spacing(1),
...
var HeaderSpacerStyled = styled21(Box11, {
  name: "MuiHeader",
  slot: "Spacer"
})({
  flexGrow: 1
...
var Header = ({
  ...
  const contextValue = React9.useMemo(() => ({ minimal }), [minimal]);
  return /* @__PURE__ */ jsx32(HeaderContext.Provider, { value: contextValue, children: /* @__PURE__ */ jsx32(HeaderRootStyled, { position: "static", color: "default", elevation: 0, sx, children: /* @__PURE__ */ jsx32(HeaderToolbar, { children }) }) });
};
var HeaderSpacer = ({ sx }) => /* @__PURE__ */ jsx32(HeaderSpacerStyled, { sx });
...
var SidebarNavRoot = styled22(Box12, {
  name: "MuiSidebar",
  slot: "Nav"
})(({ theme }) => ({
  flex: 1,
...
var SidebarNavDivider = styled22(Divider3, {
  name: "MuiSidebar",
  slot: "NavDivider"
})(({ theme }) => ({
...
var SidebarNav = ({
  ...
  return /* @__PURE__ */ jsx33(SidebarNavRoot, { component: "nav", sx, children: childArray.map((child, index) => /* @__PURE__ */ jsxs10(React11.Fragment, { children: [
    index > 0 && showDividers && !collapsed && /* @__PURE__ */ jsx33(SidebarNavDivider, {}),
    child
  ] }, index)) });
};

// src/components/Sidebar/SidebarCategory.tsx
import * as React12 from "react";
import Box13 from "@mui/material/Box";
import List from "@mui/material/List";
import { styled as styled24 } from "@mui/material/styles";

// src/components/Sidebar/SidebarCategoryLabel.tsx
import Typography7 from "@mui/material/Typography";
import { styled as styled23 } from "@mui/material/styles";
import { jsx as jsx34 } from "react/jsx-runtime";
var SidebarCategoryLabelRoot = styled23(Typography7, {
  name: "MuiSidebar",
  slot: "CategoryLabel",
...
var SidebarCategoryLabel = ({ children, sx }) => {
  const { collapsed } = useSidebar();
  return /* @__PURE__ */ jsx34(SidebarCategoryLabelRoot, { variant: "caption", collapsed, sx, children });
};
SidebarCategoryLabel.displayName = "SidebarCategoryLabel";

// src/components/Sidebar/SidebarCategory.tsx
import { jsx as jsx35, jsxs as jsxs11 } from "react/jsx-runtime";
var SidebarCategoryRoot = styled24(Box13, {
  name: "MuiSidebar",
  slot: "Category"
})(({ theme }) => ({
  marginBottom: theme.spacing(1)
}));
var separateChildren = (children) => {
  let labelChild = null;
  const otherChildren = [];
...
var SidebarCategory = ({
  ...
  return /* @__PURE__ */ jsxs11(SidebarCategoryRoot, { sx, children: [
    labelChild,
    /* @__PURE__ */ jsx35(List, { disablePadding: true, children: otherChildren })
  ] });
};
...
import { ChevronDown as ChevronDown2, ChevronUp } from "@wso2/oxygen-ui-icons-react";

// src/components/Sidebar/SidebarItemContext.tsx
import * as React13 from "react";
import { jsx as jsx36 } from "react/jsx-runtime";
var SidebarItemContext = React13.createContext(null);
var useSidebarItemContext = () => {
  const context = React13.useContext(SidebarItemContext);
  if (!context) {
    throw new Error(
...
var SidebarItemProvider = ({ value, children }) => {
  return /* @__PURE__ */ jsx36(SidebarItemContext.Provider, { value, children });
};

// src/components/Sidebar/SidebarItemIcon.tsx
import * as React14 from "react";
import ListItemIcon from "@mui/material/ListItemIcon";
import { styled as styled25 } from "@mui/material/styles";
import { jsx as jsx37 } from "react/jsx-runtime";
var SidebarItemIconRoot = styled25(ListItemIcon, {
  name: "MuiSidebar",
  slot: "ItemIcon",
  ...
  color: ownerState.isActive ? (theme.vars || theme).palette.primary.main : "inherit"
}));
var SidebarItemIcon = ({
  children,
  sx
  ...
  const iconWithSize = React14.isValidElement(children) ? React14.cloneElement(children, __spreadProps(__spreadValues({}, children.props), {
    size: (_a = children.props.size) != null ? _a : 20
  })) : children;
...
var SidebarItemLabelRoot = styled26(ListItemText, {
  ...
  transition: theme.transitions.create(["opacity", "width", "margin"], {
    easing: theme.transitions.easing.sharp,
    duration: ownerState.collapsed ? theme.transitions.duration.leavingScreen : theme.transitions.duration.enteringScreen
  }),
...
var SidebarItemLabel = ({
  children,
  sx
}) => {
  const { collapsed } = useSidebar();
  const { isActive } = useSidebarItemContext();
  return /* @__PURE__ */ jsx38(SidebarItemLabelRoot, { primary: children, ownerState: { isActive, collapsed }, sx });
};
SidebarItemLabel.displayName = "SidebarItemLabel";

// src/components/Sidebar/SidebarItemBadge.tsx
import Chip from "@mui/material/Chip";
import { styled as styled27 } from "@mui/material/styles";
import { jsx as jsx39 } from "react/jsx-runtime";
var SidebarItemBadgeRoot = styled27(Chip, {
  name: "MuiSidebar",
  slot: "ItemBadge"
})({
  height: 20,
...
var SidebarItemBadge = ({
  ...
  return /* @__PURE__ */ jsx39(SidebarItemBadgeRoot, { label: children, size: "small", color, sx });
};
SidebarItemBadge.displayName = "SidebarItemBadge";

// src/components/Sidebar/SidebarItem.tsx
import { Fragment as Fragment5, jsx as jsx40, jsxs as jsxs12 } from "react/jsx-runtime";
var SidebarItemRoot = styled28(ListItem, {
  name: "MuiSidebar",
  slot: "Item"
})({
  display: "block",
...
var SidebarItemButton = styled28(ListItemButton, {
  name: "MuiSidebar",
  slot: "ItemButton",
  shouldForwardProp: (prop) => prop !== "ownerState"
})(({ theme, ownerState }) => ({
...
var SidebarItemChevron = styled28(Box14, {
  name: "MuiSidebar",
  slot: "ItemChevron"
})({
  marginLeft: "auto",
...
var SidebarItemPopover = styled28(Popover2, {
  name: "MuiSidebar",
  slot: "ItemPopover"
})({
  pointerEvents: "none"
});
var SidebarItemPopoverList = styled28(List2, {
  name: "MuiSidebar",
...
var SidebarItemPopoverButton = styled28(ListItemButton, {
  name: "MuiSidebar",
...
var CHILD_DISPLAY_NAMES = [
  "SidebarItemIcon",
  "SidebarItemLabel",
  "SidebarItemBadge"
];
var separateChildren2 = (children) => {
  const composableChildren = [];
  const nestedItems = [];
  React15.Children.toArray(children).forEach((child) => {
    var _a;
...
var extractItemContent = (itemChildren) => {
  let icon = null;
  let label = "";
  React15.Children.forEach(itemChildren, (child) => {
    var _a;
    if (React15.isValidElement(child)) {
      const displayName = (_a = child.type) == null ? void 0 : _a.displayName;
      const props = child.props;
...
var SidebarItem = ({
  ...
  const { composableChildren, nestedItems } = separateChildren2(children);
  const hasNestedItems = nestedItems.length > 0;
  const isActive = activeItem === id;
  const isExpanded = expandedMenus[id] || false;
  const hasActiveChild = React15.useMemo(() => {
  ...
  const handleClick = () => {
    if (hasNestedItems) {
      onToggleExpand == null ? void 0 : onToggleExpand(id);
    } else {
  ...
  const buttonContent = /* @__PURE__ */ jsx40(
    SidebarItemButton,
    {
      ...
      ownerState,
      sx,
      children: /* @__PURE__ */ jsxs12(SidebarItemProvider, { value: contextValue, children: [
        composableChildren,
        !collapsed && hasNestedItems && /* @__PURE__ */ jsx40(SidebarItemChevron, { children: isExpanded ? /* @__PURE__ */ jsx40(ChevronUp, { size: 16 }) : /* @__PURE__ */ jsx40(ChevronDown2, { size: 16 }) }),
        !collapsed && !hasNestedItems && /* @__PURE__ */ jsx40(Box14, { sx: { ml: "auto", width: 16, pl: 1 } })
      ] })
    }
  );
  const wrappedContent = link ? /* @__PURE__ */ jsx40(Fragment5, { children: React15.cloneElement(link, {}, buttonContent) }) : buttonContent;
  const collapsedWithNested = collapsed && hasNestedItems;
  const handlePopoverItemClick = (itemId) => {
    onSelect == null ? void 0 : onSelect(itemId);
    setPopoverAnchor(null);
  };
  return /* @__PURE__ */ jsxs12(Fragment5, { children: [
    /* @__PURE__ */ jsx40(
      SidebarItemRoot,
      {
        ...
        children: collapsed ? (
          ...
          collapsedWithNested ? wrappedContent : /* @__PURE__ */ jsx40(Tooltip3, { title: tooltipLabel, placement: "right", arrow: true, children: wrappedContent })
        ) : wrappedContent
      }
    ),
    collapsedWithNested && /* @__PURE__ */ jsx40(
      SidebarItemPopover,
      {
        open: popoverOpen,
        ...
        children: /* @__PURE__ */ jsx40(SidebarItemPopoverList, { disablePadding: true, children: nestedItems.map((child, index) => {
          if (React15.isValidElement(child)) {
            const childProps = child.props;
            ...
            return /* @__PURE__ */ jsxs12(
              SidebarItemPopoverButton,
              {
                ...
                children: [
                  icon && /* @__PURE__ */ jsx40(ListItemIcon2, { sx: { minWidth: "auto" }, children: icon }),
                  /* @__PURE__ */ jsx40(ListItemText2, { primary: label })
                ]
              },
              childProps.id || index
            );
    ...
    hasNestedItems && !collapsed && /* @__PURE__ */ jsx40(Collapse, { in: isExpanded, timeout: "auto", unmountOnExit: true, children: /* @__PURE__ */ jsx40(List2, { disablePadding: true, children: nestedItems.map((child, index) => {
      if (React15.isValidElement(child)) {
...
import { Fragment as Fragment6, jsx as jsx41, jsxs as jsxs13 } from "react/jsx-runtime";
var SidebarFooterRoot = styled29(Box15, {
  name: "MuiSidebar",
  slot: "Footer"
})(({ theme }) => ({
  paddingTop: theme.spacing(1),
...
var SidebarFooter = ({
  ...
  return /* @__PURE__ */ jsxs13(Fragment6, { children: [
    showDivider && /* @__PURE__ */ jsx41(Divider4, {}),
    /* @__PURE__ */ jsx41(SidebarFooterRoot, { sx, children })
  ] });
};
...
var SidebarUserAvatar = ({
  children,
  src,
  alt,
  sx
}) => {
  return /* @__PURE__ */ jsx42(SidebarUserAvatarRoot, { src, alt, sx, children });
};
SidebarUserAvatar.displayName = "SidebarUserAvatar";

// src/components/Sidebar/SidebarUserName.tsx
import Typography8 from "@mui/material/Typography";
import { styled as styled31 } from "@mui/material/styles";
import { jsx as jsx43 } from "react/jsx-runtime";
var SidebarUserNameRoot = styled31(Typography8, {
  name: "MuiSidebar",
  slot: "UserName"
})({
  fontWeight: 600,
...
var SidebarUserName = ({
  ...
  return /* @__PURE__ */ jsx43(SidebarUserNameRoot, { variant: "body2", sx, children });
};
SidebarUserName.displayName = "SidebarUserName";

// src/components/Sidebar/SidebarUserEmail.tsx
import Typography9 from "@mui/material/Typography";
import { styled as styled32 } from "@mui/material/styles";
import { jsx as jsx44 } from "react/jsx-runtime";
var SidebarUserEmailRoot = styled32(Typography9, {
  name: "MuiSidebar",
  slot: "UserEmail"
})(({ theme }) => ({
  color: (theme.vars || theme).palette.text.secondary,
...
var SidebarUserEmail = ({
  ...
  return /* @__PURE__ */ jsx44(SidebarUserEmailRoot, { variant: "caption", sx, children });
};
SidebarUserEmail.displayName = "SidebarUserEmail";

// src/components/Sidebar/SidebarUser.tsx
import { Fragment as Fragment7, jsx as jsx45, jsxs as jsxs14 } from "react/jsx-runtime";
var SidebarUserRoot = styled33(Box16, {
  name: "MuiSidebar",
  slot: "User"
})(({ theme }) => ({
  padding: theme.spacing(2)
}));
var SidebarUserButton = styled33(ListItemButton2, {
  name: "MuiSidebar",
  slot: "UserButton",
  shouldForwardProp: (prop) => prop !== "ownerState"
})(({ theme, ownerState }) => ({
...
var SidebarUserTextContainer = styled33(Box16, {
  name: "MuiSidebar",
...
var separateChildren3 = (children) => {
  ...
  React16.Children.forEach(children, (child) => {
    ...
    if (React16.isValidElement(child)) {
      ...
      if (displayName === "SidebarUserAvatar") {
        avatarChild = child;
      } else if (displayName === "SidebarUserName" || displayName === "SidebarUserEmail") {
...
var SidebarUser = ({
  ...
  const { collapsed } = useSidebar();
  const { avatarChild, textChildren } = separateChildren3(children);
  const tooltipText = getTooltipText(children);
  const ownerState = { collapsed };
  const content = /* @__PURE__ */ jsxs14(SidebarUserButton, { onClick, ownerState, children: [
    avatarChild,
    /* @__PURE__ */ jsx45(SidebarUserTextContainer, { collapsed, children: textChildren })
  ] });
  return /* @__PURE__ */ jsxs14(Fragment7, { children: [
    showDivider && /* @__PURE__ */ jsx45(Divider5, {}),
    /* @__PURE__ */ jsx45(SidebarUserRoot, { sx, children: collapsed ? /* @__PURE__ */ jsx45(Tooltip4, { title: tooltipText, placement: "right", arrow: true, children: content }) : content })
  ] });
};
...
var COLLAPSED_SIDEBAR_WIDTH = 64;
var SidebarRootStyled = styled34(Box17, {
  name: "MuiSidebar",
  slot: "Root",
  shouldForwardProp: (prop) => prop !== "ownerState"
})(({ theme, ownerState }) => ({
...
var Sidebar = ({
  ...
  var _a, _b, _c;
  const appShellContext = React17.useContext(AppShellContext);
  const collapsed = (_a = collapsedProp != null ? collapsedProp : appShellContext == null ? void 0 : appShellContext.state.sidebarCollapsed) != null ? _a : false;
  const activeItem = activeItemProp != null ? activeItemProp : appShellContext == null ? void 0 : appShellContext.state.activeMenuItem;
  const expandedMenus = React17.useMemo(
    () => {
      var _a2;
      return (_a2 = expandedMenusProp != null ? expandedMenusProp : appShellContext == null ? void 0 : appShellContext.state.expandedMenus) != null ? _a2 : {};
    },
    [expandedMenusProp, appShellContext == null ? void 0 : appShellContext.state.expandedMenus]
  );
  const onSelect = onSelectProp != null ? onSelectProp : appShellContext == null ? void 0 : appShellContext.actions.setActiveMenuItem;
  const onToggleExpand = onToggleExpandProp != null ? onToggleExpandProp : appShellContext == null ? void 0 : appShellContext.actions.toggleMenu;
  const width = (_b = widthProp != null ? widthProp : appShellContext == null ? void 0 : appShellContext.state.sidebarWidth) != null ? _b : SIDEBAR_WIDTH;
  const collapsedWidth = (_c = collapsedWidthProp != null ? collapsedWidthProp : appShellContext == null ? void 0 : appShellContext.state.sidebarCollapsedWidth) != null ? _c : COLLAPSED_SIDEBAR_WIDTH;
  ...
  return /* @__PURE__ */ jsx46(SidebarContext.Provider, { value: contextValue, children: /* @__PURE__ */ jsx46(SidebarRootStyled, { component: "aside", ownerState, sx, children }) });
};
...
import { styled as styled50 } from "@mui/material/styles";

// src/components/NotificationPanel/context.ts
import * as React18 from "react";
var NotificationPanelContext = React18.createContext(null);
var useNotificationPanel = () => {
  const context = React18.useContext(NotificationPanelContext);
  if (!context) {
    throw new Error(
...
// src/components/NotificationPanel/NotificationHeader.tsx
...
var NotificationHeaderRoot = styled35(Box18, {
...
var NotificationHeaderContent = styled35(Box18, {
  name: "MuiNotificationPanel",
  slot: "HeaderContent"
})(({ theme }) => ({
  display: "flex",
...
var separateChildren4 = (children) => {
  const leftChildren = [];
  let closeChild = null;
...
var NotificationHeader = ({
  ...
  const { leftChildren, closeChild } = separateChildren4(children);
  return /* @__PURE__ */ jsxs15(NotificationHeaderRoot, { sx, children: [
    /* @__PURE__ */ jsx47(NotificationHeaderContent, { children: leftChildren }),
    closeChild
  ] });
};
NotificationHeader.displayName = "NotificationHeader";

// src/components/NotificationPanel/NotificationHeaderIcon.tsx
import Box19 from "@mui/material/Box";
import { styled as styled36 } from "@mui/material/styles";
import { jsx as jsx48 } from "react/jsx-runtime";
var NotificationHeaderIconRoot = styled36(Box19, {
  name: "MuiNotificationPanel",
  slot: "HeaderIcon"
})({
  display: "flex",
...
var NotificationHeaderIcon = ({
  children,
  sx
}) => {
  return /* @__PURE__ */ jsx48(NotificationHeaderIconRoot, { sx, children });
};
NotificationHeaderIcon.displayName = "NotificationHeaderIcon";

// src/components/NotificationPanel/NotificationHeaderTitle.tsx
import Typography10 from "@mui/material/Typography";
import { styled as styled37 } from "@mui/material/styles";
import { jsx as jsx49 } from "react/jsx-runtime";
var NotificationHeaderTitleRoot = styled37(Typography10, {
  name: "MuiNotificationPanel",
  slot: "HeaderTitle"
})({
  fontWeight: 600
});
var NotificationHeaderTitle = ({
  children,
  sx
}) => {
  return /* @__PURE__ */ jsx49(NotificationHeaderTitleRoot, { variant: "h6", sx, children });
};
NotificationHeaderTitle.displayName = "NotificationHeaderTitle";

// src/components/NotificationPanel/NotificationHeaderBadge.tsx
import Chip2 from "@mui/material/Chip";
import { styled as styled38 } from "@mui/material/styles";
import { jsx as jsx50 } from "react/jsx-runtime";
var NotificationHeaderBadgeRoot = styled38(Chip2, {
  name: "MuiNotificationPanel",
  slot: "HeaderBadge"
})({
  height: 20,
...
var NotificationHeaderBadge = ({
  ...
  return /* @__PURE__ */ jsx50(NotificationHeaderBadgeRoot, { label: children, size: "small", color, sx });
};
NotificationHeaderBadge.displayName = "NotificationHeaderBadge";

// src/components/NotificationPanel/NotificationHeaderClose.tsx
import IconButton4 from "@mui/material/IconButton";
import { styled as styled39 } from "@mui/material/styles";
import { X as X2 } from "@wso2/oxygen-ui-icons-react";
import { jsx as jsx51 } from "react/jsx-runtime";
var NotificationHeaderCloseRoot = styled39(IconButton4, {
  name: "MuiNotificationPanel",
  slot: "HeaderClose"
})({});
var NotificationHeaderClose = ({
  children,
  onClick,
  sx
}) => {
  ...
  return /* @__PURE__ */ jsx51(NotificationHeaderCloseRoot, { onClick: handleClick, size: "small", sx, children: children || /* @__PURE__ */ jsx51(X2, { size: 20 }) });
};
NotificationHeaderClose.displayName = "NotificationHeaderClose";

// src/components/NotificationPanel/NotificationTabs.tsx
...
var NotificationTabsRoot = styled40(Box20, {
  name: "MuiNotificationPanel",
  slot: "Tabs"
})(({ theme }) => ({
  borderBottom: `1px solid ${(theme.vars || theme).palette.divider}`
}));
var NotificationTabsInner = styled40(Tabs, {
  name: "MuiNotificationPanel",
  slot: "TabsInner"
})({
  minHeight: 44,
...
var NotificationTabLabel = styled40(Box20, {
  name: "MuiNotificationPanel",
  slot: "TabLabel"
})(({ theme }) => ({
  display: "flex",
...
var NotificationTabCount = styled40(Chip3, {
  name: "MuiNotificationPanel",
  slot: "TabCount"
})({
  height: 18,
...
var NotificationTabs = ({
  ...
  return /* @__PURE__ */ jsx52(NotificationTabsRoot, { sx, children: /* @__PURE__ */ jsx52(
    NotificationTabsInner,
    {
      value,
      onChange: (_, newValue) => onChange(newValue),
      variant: "fullWidth",
      children: tabs.map((tab, index) => /* @__PURE__ */ jsx52(
        Tab,
        {
          label: /* @__PURE__ */ jsxs16(NotificationTabLabel, { children: [
            tab.label,
            tab.count !== void 0 && tab.count > 0 && /* @__PURE__ */ jsx52(
...
// src/components/NotificationPanel/NotificationActions.tsx
...
var NotificationActionsRoot = styled41(Box21, {
  name: "MuiNotificationPanel",
  slot: "Actions"
})(({ theme }) => ({
  display: "flex",
...
var NotificationActionButton = styled41(Button3, {
  name: "MuiNotificationPanel",
  slot: "ActionButton"
})({
  textTransform: "none",
...
var NotificationActions = ({
  ...
  return /* @__PURE__ */ jsxs17(NotificationActionsRoot, { sx, children: [
    hasUnread && onMarkAllRead && /* @__PURE__ */ jsx53(
      NotificationActionButton,
      {
        size: "small",
        startIcon: /* @__PURE__ */ jsx53(CheckCheck, { size: 14 }),
        onClick: onMarkAllRead,
        children: "Mark all read"
      }
    ),
    onClearAll && /* @__PURE__ */ jsx53(
      NotificationActionButton,
      {
        size: "small",
        startIcon: /* @__PURE__ */ jsx53(Trash2, { size: 14 }),
        onClick: onClearAll,
        color: "error",
        children: "Clear all"
      }
...
// src/components/NotificationPanel/NotificationList.tsx
...
var NotificationListRoot = styled42(Box22, {
  name: "MuiNotificationPanel",
  slot: "List"
})({
  flex: 1,
...
var NotificationList = ({
  ...
  return /* @__PURE__ */ jsx54(NotificationListRoot, { sx, children: /* @__PURE__ */ jsx54(List3, { disablePadding: true, children: childArray.map((child, index) => /* @__PURE__ */ jsxs18(React20.Fragment, { children: [
    child,
    showDividers && index < childArray.length - 1 && /* @__PURE__ */ jsx54(Divider6, {})
  ] }, index)) }) });
};

// src/components/NotificationPanel/NotificationItem.tsx
...
import { styled as styled43 } from "@mui/material/styles";
import { X as X3 } from "@wso2/oxygen-ui-icons-react";

// src/components/NotificationPanel/utils.ts
import {
  Info,
  AlertTriangle,
  AlertCircle,
...
var getNotificationTypeProps = (type) => {
  switch (type) {
    case "success":
      return {
        icon: CheckCircle,
...
// src/components/NotificationPanel/NotificationItemContext.tsx
import * as React21 from "react";
import { jsx as jsx55 } from "react/jsx-runtime";
var NotificationItemContext = React21.createContext(null);
var useNotificationItemContext = () => {
  const context = React21.useContext(NotificationItemContext);
  if (!context) {
    throw new Error(
...
var NotificationItemProvider = ({ value, children }) => {
  return /* @__PURE__ */ jsx55(NotificationItemContext.Provider, { value, children });
};

// src/components/NotificationPanel/NotificationItem.tsx
import { jsx as jsx56, jsxs as jsxs19 } from "react/jsx-runtime";
var NotificationItemRoot = styled43(ListItem2, {
  name: "MuiNotificationPanel",
  slot: "Item",
  shouldForwardProp: (prop) => prop !== "ownerState"
})(({ theme, ownerState }) => ({
  backgroundColor: ownerState.read ? "transparent" : (theme.vars || theme).palette.action.hover,
  "&:hover": {
    backgroundColor: (theme.vars || theme).palette.action.selected
  }
}));
var NotificationItemButton = styled43(ListItemButton3, {
  name: "MuiNotificationPanel",
  slot: "ItemButton"
})(({ theme }) => ({
  paddingRight: theme.spacing(6)
}));
var NotificationItemDismiss = styled43(IconButton5, {
  name: "MuiNotificationPanel",
  slot: "ItemDismiss"
})({
  opacity: 0.5,
...
var NotificationItemFooter = styled43(Box23, {
  name: "MuiNotificationPanel",
  slot: "ItemFooter"
})(({ theme }) => ({
  display: "flex",
...
var separateChildren5 = (children) => {
  let avatarChild = null;
  let titleChild = null;
  let messageChild = null;
  let timestampChild = null;
...
var NotificationItem = ({
  ...
  const { avatarChild, titleChild, messageChild, timestampChild, actionChild } = separateChildren5(children);
  const contextValue = {
    id,
    type,
    typeProps,
    read,
    onMarkRead: () => onMarkRead == null ? void 0 : onMarkRead(id),
    onAction
  };
  const handleClick = () => {
    if (!read) {
      onMarkRead == null ? void 0 : onMarkRead(id);
    }
    onAction == null ? void 0 : onAction();
  };
  const ownerState = { read };
  return /* @__PURE__ */ jsx56(NotificationItemProvider, { value: contextValue, children: /* @__PURE__ */ jsx56(
    NotificationItemRoot,
    {
      disablePadding: true,
      ownerState,
      secondaryAction: onDismiss && /* @__PURE__ */ jsx56(
        NotificationItemDismiss,
        {
          ...
          children: /* @__PURE__ */ jsx56(X3, { size: 16 })
        }
      ),
      sx,
      children: /* @__PURE__ */ jsxs19(NotificationItemButton, { onClick: handleClick, children: [
        avatarChild,
        /* @__PURE__ */ jsx56(
          ListItemText3,
          {
            primary: titleChild,
            secondary: /* @__PURE__ */ jsxs19(Box23, { component: "span", children: [
              messageChild,
              /* @__PURE__ */ jsxs19(NotificationItemFooter, { children: [
                timestampChild,
                actionChild
              ] })
            ] })
...
// src/components/NotificationPanel/NotificationItemAvatar.tsx
import ListItemAvatar from "@mui/material/ListItemAvatar";
import Avatar3 from "@mui/material/Avatar";
import { styled as styled44 } from "@mui/material/styles";
import { jsx as jsx57 } from "react/jsx-runtime";
var NotificationItemAvatarStyled = styled44(Avatar3, {
  name: "MuiNotificationPanel",
  slot: "ItemAvatar",
  shouldForwardProp: (prop) => prop !== "ownerState"
})(({ ownerState }) => ({
  ...
  fontSize: ownerState.hasChildren ? 14 : void 0,
  fontWeight: ownerState.hasChildren ? 600 : void 0
}));
var NotificationItemAvatar = ({
  children,
  sx
}) => {
  ...
  return /* @__PURE__ */ jsx57(ListItemAvatar, { children: /* @__PURE__ */ jsx57(NotificationItemAvatarStyled, { ownerState, sx, children: children || /* @__PURE__ */ jsx57(Icon, { size: 20 }) }) });
};
NotificationItemAvatar.displayName = "NotificationItemAvatar";

// src/components/NotificationPanel/NotificationItemTitle.tsx
...
var NotificationItemTitleRoot = styled45(Box24, {
  name: "MuiNotificationPanel",
  slot: "ItemTitle"
})(({ theme }) => ({
  display: "flex",
...
var NotificationItemTitleText = styled45(Typography11, {
  name: "MuiNotificationPanel",
  slot: "ItemTitleText",
  shouldForwardProp: (prop) => prop !== "ownerState"
})(({ ownerState }) => ({
...
var NotificationItemUnreadDot = styled45(Box24, {
  name: "MuiNotificationPanel",
  slot: "ItemUnreadDot"
})(({ theme }) => ({
  width: 8,
...
var NotificationItemTitle = ({
  children,
  showUnreadIndicator = true,
  sx
}) => {
  const { read } = useNotificationItemContext();
  return /* @__PURE__ */ jsxs20(NotificationItemTitleRoot, { sx, children: [
    /* @__PURE__ */ jsx58(NotificationItemTitleText, { variant: "body2", ownerState: { read }, children }),
    showUnreadIndicator && !read && /* @__PURE__ */ jsx58(NotificationItemUnreadDot, {})
  ] });
};
NotificationItemTitle.displayName = "NotificationItemTitle";

// src/components/NotificationPanel/NotificationItemMessage.tsx
import Typography12 from "@mui/material/Typography";
import { styled as styled46 } from "@mui/material/styles";
import { jsx as jsx59 } from "react/jsx-runtime";
var NotificationItemMessageRoot = styled46(Typography12, {
  name: "MuiNotificationPanel",
  slot: "ItemMessage"
})(({ theme }) => ({
  display: "block",
...
var NotificationItemMessage = ({
  children,
  sx
}) => {
  return /* @__PURE__ */ jsx59(NotificationItemMessageRoot, { component: "span", variant: "caption", sx, children });
};
NotificationItemMessage.displayName = "NotificationItemMessage";

// src/components/NotificationPanel/NotificationItemTimestamp.tsx
import Typography13 from "@mui/material/Typography";
import { styled as styled47 } from "@mui/material/styles";
import { jsx as jsx60 } from "react/jsx-runtime";
var NotificationItemTimestampRoot = styled47(Typography13, {
  name: "MuiNotificationPanel",
  slot: "ItemTimestamp"
})(({ theme }) => ({
...
var NotificationItemTimestamp = ({
  children,
  sx
}) => {
  return /* @__PURE__ */ jsx60(NotificationItemTimestampRoot, { component: "span", variant: "caption", sx, children });
};
NotificationItemTimestamp.displayName = "NotificationItemTimestamp";

// src/components/NotificationPanel/NotificationItemAction.tsx
import Chip4 from "@mui/material/Chip";
import { styled as styled48 } from "@mui/material/styles";
import { jsx as jsx61 } from "react/jsx-runtime";
var NotificationItemActionRoot = styled48(Chip4, {
  name: "MuiNotificationPanel",
  slot: "ItemAction"
})({
  height: 20,
...
var NotificationEmptyStateMessage = styled49(Typography14, {
  name: "MuiNotificationPanel",
  slot: "EmptyStateMessage"
})(({ theme }) => ({
  color: (theme.vars || theme).palette.text.secondary
}));
var NotificationEmptyState = ({
  message = "No notifications",
  icon,
  sx
}) => {
  return /* @__PURE__ */ jsxs21(NotificationEmptyStateRoot, { sx, children: [
    icon || /* @__PURE__ */ jsx62(BellOff, { size: 48, style: { opacity: 0.3, marginBottom: 16 } }),
    /* @__PURE__ */ jsx62(NotificationEmptyStateMessage, { variant: "body2", children: message })
  ] });
};

// src/components/NotificationPanel/NotificationPanel.tsx
import { jsx as jsx63 } from "react/jsx-runtime";
var NotificationPanelRoot = styled50(Drawer, {
  name: "MuiNotificationPanel",
  slot: "Root",
  shouldForwardProp: (prop) => prop !== "ownerState"
})(({ theme, ownerState }) => ({
...
var NotificationPanel = ({
  ...
  var _a;
  const appShellContext = React23.useContext(AppShellContext);
  const open = (_a = openProp != null ? openProp : appShellContext == null ? void 0 : appShellContext.state.notificationPanelOpen) != null ? _a : false;
  const onClose = React23.useMemo(
    () => {
      var _a2;
      return (_a2 = onCloseProp != null ? onCloseProp : appShellContext == null ? void 0 : appShellContext.actions.toggleNotificationPanel) != null ? _a2 : (() => {
      });
    },
    [onCloseProp, appShellContext == null ? void 0 : appShellContext.actions.toggleNotificationPanel]
  );
  const contextValue = React23.useMemo(() => ({ onClose }), [onClose]);
  const ownerState = { width };
  return /* @__PURE__ */ jsx63(NotificationPanelContext.Provider, { value: contextValue, children: /* @__PURE__ */ jsx63(
...
import { styled as styled54 } from "@mui/material/styles";

// src/components/Footer/FooterCopyright.tsx
import Typography15 from "@mui/material/Typography";
import { styled as styled51 } from "@mui/material/styles";
import { jsx as jsx64 } from "react/jsx-runtime";
var StyledCopyrightText = styled51(Typography15, {
  name: "MuiFooter",
  slot: "CopyrightText"
})(({ theme }) => ({
  color: (theme.vars || theme).palette.text.secondary
}));
var FooterCopyright = ({ children }) => {
  return /* @__PURE__ */ jsx64(StyledCopyrightText, { variant: "caption", children });
};
FooterCopyright.displayName = "Footer.Copyright";

// src/components/Footer/FooterVersion.tsx
import Typography16 from "@mui/material/Typography";
import { styled as styled52 } from "@mui/material/styles";
import { jsx as jsx65 } from "react/jsx-runtime";
var StyledVersion = styled52(Typography16, {
  name: "MuiFooter",
  slot: "Version"
})(({ theme }) => ({
  color: (theme.vars || theme).palette.text.disabled,
...
var FooterVersion = ({ children }) => {
  return /* @__PURE__ */ jsx65(StyledVersion, { variant: "caption", children });
};
FooterVersion.displayName = "Footer.Version";

// src/components/Footer/FooterLink.tsx
import Link2 from "@mui/material/Link";
import { styled as styled53 } from "@mui/material/styles";
import { jsx as jsx66 } from "react/jsx-runtime";
var StyledLink = styled53(Link2, {
  name: "MuiFooter",
  slot: "Link"
})(({ theme }) => ({
  color: (theme.vars || theme).palette.text.secondary,
...
var FooterLink = (_a) => {
  ...
  return /* @__PURE__ */ jsx66(StyledLink, __spreadProps(__spreadValues({ href, underline: "hover" }, props), { children }));
};
FooterLink.displayName = "Footer.Link";

// src/components/Footer/FooterDivider.tsx
import Divider7 from "@mui/material/Divider";
...
var FooterContent = styled54(Box26, {
  name: "MuiFooter",
  slot: "Content"
})(({ theme }) => ({
  display: "flex",
...
var FooterRight = styled54(Box26, {
  name: "MuiFooter",
  slot: "Right"
})(({ theme }) => ({
  display: "flex",
...
var Footer = ({ children, sx }) => {
  const childrenArray = React24.Children.toArray(children);
  const leftChildren = [];
  const rightChildren = [];
  childrenArray.forEach((child) => {
    if (React24.isValidElement(child)) {
      if (child.type === FooterCopyright || child.type === FooterVersion || child.type === FooterDivider) {
        leftChildren.push(child);
  ...
  return /* @__PURE__ */ jsx68(FooterRoot, { component: "footer", sx, children: /* @__PURE__ */ jsxs22(FooterContent, { children: [
    leftChildren.length > 0 && /* @__PURE__ */ jsx68(FooterLeft, { children: leftChildren }),
    rightChildren.length > 0 && /* @__PURE__ */ jsx68(FooterRight, { children: rightChildren })
  ] }) });
};
...
// src/components/UserMenu/UserMenuContext.tsx
import * as React25 from "react";
var UserMenuContext = React25.createContext(void 0);
var useUserMenu = () => {
  const context = React25.useContext(UserMenuContext);
  if (!context) {
...
// src/components/UserMenu/UserMenuTrigger.tsx
...
import { styled as styled55 } from "@mui/material/styles";
import { jsx as jsx69, jsxs as jsxs23 } from "react/jsx-runtime";
var StyledTrigger = styled55(IconButton6, {
  name: "MuiUserMenu",
  slot: "Trigger"
})(({ theme, showName }) => __spreadValues({
  padding: theme.spacing(0.5),
  gap: theme.spacing(1)
}, showName && {
...
var StyledAvatar2 = styled55(Avatar4, {
  name: "MuiUserMenu",
  slot: "Avatar"
})(({ theme }) => ({
  width: 32,
...
var StyledNameText = styled55("span", {
  name: "MuiUserMenu",
  slot: "NameText"
})(({ theme }) => ({
  fontSize: 14,
...
var UserMenuTrigger = ({ name, avatar, showName = false }) => {
  const { open, handleOpen } = useUserMenu();
  return /* @__PURE__ */ jsx69(Tooltip5, { title: "Account", children: /* @__PURE__ */ jsxs23(
    StyledTrigger,
    {
      onClick: handleOpen,
      size: "small",
      ...
      "aria-controls": open ? "user-menu" : void 0,
      "aria-haspopup": "true",
      "aria-expanded": open ? "true" : void 0,
      children: [
        /* @__PURE__ */ jsx69(StyledAvatar2, { src: avatar || void 0, alt: name, children: !avatar && name.charAt(0) }),
        showName && /* @__PURE__ */ jsx69(StyledNameText, { children: name })
      ]
    }
  ) });
};
...
// src/components/UserMenu/UserMenuHeader.tsx
import Divider8 from "@mui/material/Divider";
import Box27 from "@mui/material/Box";
import Avatar5 from "@mui/material/Avatar";
import Typography17 from "@mui/material/Typography";
import Chip5 from "@mui/material/Chip";
import { styled as styled56 } from "@mui/material/styles";
import { Fragment as Fragment9, jsx as jsx70, jsxs as jsxs24 } from "react/jsx-runtime";
var StyledHeaderBox = styled56(Box27, {
  name: "MuiUserMenu",
  slot: "HeaderBox"
})(({ theme }) => ({
  padding: theme.spacing(2),
...
var StyledHeaderContent = styled56(Box27, {
  name: "MuiUserMenu",
  slot: "HeaderContent"
})(({ theme }) => ({
  display: "flex",
...
var StyledHeaderAvatar = styled56(Avatar5, {
  name: "MuiUserMenu",
  slot: "HeaderAvatar"
})(({ theme }) => ({
  width: 40,
...
var StyledUserInfo = styled56(Box27, {
  name: "MuiUserMenu",
  slot: "UserInfo"
})(({ theme }) => ({
  display: "flex",
...
var StyledNameRow = styled56(Box27, {
  name: "MuiUserMenu",
  slot: "NameRow"
})(({ theme }) => ({
  display: "flex",
...
var StyledName = styled56(Typography17, {
  name: "MuiUserMenu",
  slot: "Name"
})({
  fontWeight: 600,
...
var StyledRoleChip = styled56(Chip5, {
  name: "MuiUserMenu",
  slot: "RoleChip"
})({
  height: 20,
...
var StyledEmail = styled56(Typography17, {
  name: "MuiUserMenu",
  slot: "Email"
})(({ theme }) => ({
  color: (theme.vars || theme).palette.text.secondary,
...
var UserMenuHeader = ({ name, email, avatar, role }) => {
  return /* @__PURE__ */ jsxs24(Fragment9, { children: [
    /* @__PURE__ */ jsx70(StyledHeaderBox, { children: /* @__PURE__ */ jsxs24(StyledHeaderContent, { children: [
      /* @__PURE__ */ jsx70(StyledHeaderAvatar, { src: avatar || void 0, alt: name, children: !avatar && name.charAt(0) }),
      /* @__PURE__ */ jsxs24(StyledUserInfo, { children: [
        /* @__PURE__ */ jsxs24(StyledNameRow, { children: [
          /* @__PURE__ */ jsx70(StyledName, { variant: "subtitle2", children: name }),
          role && /* @__PURE__ */ jsx70(
            StyledRoleChip,
            {
              label: role,
        ...
        /* @__PURE__ */ jsx70(StyledEmail, { variant: "caption", children: email })
      ] })
    ] }) }),
    /* @__PURE__ */ jsx70(Divider8, {})
  ] });
};
UserMenuHeader.displayName = "UserMenu.Header";

// src/components/UserMenu/UserMenuItem.tsx
import * as React26 from "react";
import MenuItem3 from "@mui/material/MenuItem";
import ListItemIcon3 from "@mui/material/ListItemIcon";
import ListItemText4 from "@mui/material/ListItemText";
import Box28 from "@mui/material/Box";
import Chip6 from "@mui/material/Chip";
import { styled as styled57 } from "@mui/material/styles";
import { ChevronRight } from "@wso2/oxygen-ui-icons-react";
import { jsx as jsx71, jsxs as jsxs25 } from "react/jsx-runtime";
var StyledMenuItem2 = styled57(MenuItem3, {
  name: "MuiUserMenu",
  slot: "MenuItem"
})(({ theme }) => ({
...
var StyledBillingChip = styled57(Chip6, {
  name: "MuiUserMenu",
  slot: "BillingChip"
})(() => ({
  height: 20,
...
var UserMenuItem = ({
  ...
  return /* @__PURE__ */ jsxs25(StyledMenuItem2, { onClick: handleClick, children: [
    icon && /* @__PURE__ */ jsx71(ListItemIcon3, { children: React26.isValidElement(icon) ? React26.cloneElement(icon, __spreadProps(__spreadValues({}, icon.props), {
      size: (_a = icon.props.size) != null ? _a : 18
    })) : icon }),
    /* @__PURE__ */ jsx71(ListItemText4, { primary: label }),
    /* @__PURE__ */ jsxs25(Box28, { sx: { display: "flex", alignItems: "center", gap: 0.5 }, children: [
      badge && /* @__PURE__ */ jsx71(
        StyledBillingChip,
        {
          label: badge,
          size: "small",
      ...
      /* @__PURE__ */ jsx71(ChevronRight, { size: 16, style: { color: "var(--mui-palette-text-secondary)" } })
    ] })
  ] });
};
UserMenuItem.displayName = "UserMenu.Item";

// src/components/UserMenu/UserMenuLogout.tsx
import * as React27 from "react";
import MenuItem4 from "@mui/material/MenuItem";
import ListItemIcon4 from "@mui/material/ListItemIcon";
import ListItemText5 from "@mui/material/ListItemText";
import { styled as styled58 } from "@mui/material/styles";
import { jsx as jsx72, jsxs as jsxs26 } from "react/jsx-runtime";
var StyledLogoutItem = styled58(MenuItem4, {
  name: "MuiUserMenu",
  slot: "LogoutItem"
})(({ theme }) => ({
  paddingTop: theme.spacing(1.5),
...
var UserMenuLogout = ({
  ...
  return /* @__PURE__ */ jsxs26(StyledLogoutItem, { onClick: handleClick, children: [
    icon && /* @__PURE__ */ jsx72(ListItemIcon4, { children: React27.isValidElement(icon) ? React27.cloneElement(icon, __spreadProps(__spreadValues({}, icon.props), {
      size: (_a = icon.props.size) != null ? _a : 18
    })) : icon }),
    /* @__PURE__ */ jsx72(ListItemText5, { primary: label })
  ] });
};
UserMenuLogout.displayName = "UserMenu.Logout";

// src/components/UserMenu/UserMenuDivider.tsx
import Divider9 from "@mui/material/Divider";
import { jsx as jsx73 } from "react/jsx-runtime";
var UserMenuDivider = () => /* @__PURE__ */ jsx73(Divider9, {});
UserMenuDivider.displayName = "UserMenu.Divider";

// src/components/UserMenu/UserMenu.tsx
import { jsx as jsx74, jsxs as jsxs27 } from "react/jsx-runtime";
var UserMenu = ({ children }) => {
  ...
  const triggerChild = childrenArray.find(
    (child) => React28.isValidElement(child) && child.type === UserMenuTrigger
  );
  const menuChildren = childrenArray.filter(
    (child) => React28.isValidElement(child) && child.type !== UserMenuTrigger
  );
  return /* @__PURE__ */ jsxs27(UserMenuContext.Provider, { value: { open, anchorEl, handleOpen, handleClose }, children: [
    triggerChild,
    /* @__PURE__ */ jsx74(
      Menu2,
      {
...
import { styled as styled59 } from "@mui/material/styles";
import { jsx as jsx75, jsxs as jsxs28 } from "react/jsx-runtime";
var NotificationBannerAlert = styled59(Alert, {
...
var NotificationBannerContent = styled59(Box29, {
  name: "MuiNotificationBanner",
  slot: "Content"
})({
  display: "flex",
...
var NotificationBannerAction = styled59(Button4, {
  name: "MuiNotificationBanner",
  slot: "Action"
})({
  fontWeight: 600,
...
var NotificationBanner = ({
  ...
  const [isVisible, setIsVisible] = React29.useState(visible);
  React29.useEffect(() => {
  ...
  return /* @__PURE__ */ jsx75(Collapse2, { in: isVisible, children: /* @__PURE__ */ jsx75(
    NotificationBannerAlert,
    {
      ...
      sx,
      action: actionLabel && onAction ? /* @__PURE__ */ jsx75(
      ...
      children: /* @__PURE__ */ jsxs28(NotificationBannerContent, { children: [
        title && /* @__PURE__ */ jsx75(AlertTitle, { sx: { mb: 0 }, children: title }),
        /* @__PURE__ */ jsx75(Box29, { component: "span", children: message })
      ] })
    }
  ) });
};

// src/components/Form/CardButton.tsx
import { Card as Card2, ButtonBase, Box as Box30, styled as styled60 } from "@mui/material";
import { CardHeader, CardContent as CardContent2, CardActions, CardMedia } from "@mui/material";
import { jsx as jsx76 } from "react/jsx-runtime";
var StyledCardButton = styled60(Card2, {
  shouldForwardProp: (prop) => prop !== "selected" && prop !== "disabled"
})(({ theme, selected, disabled, alignItems = "flex-start" }) => ({
  flexDirection: "column",
  alignItems,
  display: "flex",
  textAlign: "left",
...
var CardButton = (props) => {
  const _a = props, { disabled, selected, alignItems = "flex-start" } = _a, rest = __objRest(_a, ["disabled", "selected", "alignItems"]);
...
var DisappearingCardButtonContent = (props) => /* @__PURE__ */ jsx76(Box30, __spreadValues({ className: "creation-flow-card-actions" }, props));

// src/components/Form/Stack.tsx
import { Stack as OxygenStack } from "@mui/material";
import { jsx as jsx77 } from "react/jsx-runtime";
var Stack2 = (props) => {
  return /* @__PURE__ */ jsx77(OxygenStack, __spreadValues({ spacing: 2 }, props));
};

// src/components/Form/Typography.tsx
import { Typography as Typography18 } from "@mui/material";
import { jsx as jsx78 } from "react/jsx-runtime";
var Header2 = (props) => {
  const _a = props, { children } = _a, rest = __objRest(_a, ["children"]);
  return /* @__PURE__ */ jsx78(Typography18, __spreadProps(__spreadValues({}, rest), { variant: "h4", children }));
};
var Subheader = (props) => {
  const _a = props, { children } = _a, rest = __objRest(_a, ["children"]);
  return /* @__PURE__ */ jsx78(Typography18, __spreadProps(__spreadValues({}, rest), { variant: "h5", children }));
};
var Body = (props) => {
  const _a = props, { children } = _a, rest = __objRest(_a, ["children"]);
  return /* @__PURE__ */ jsx78(Typography18, __spreadProps(__spreadValues({}, rest), { variant: "body2", children }));
};

// src/components/Form/Section.tsx
import { Card as Card3, CardContent as CardContent3, Stack as Stack3 } from "@mui/material";
import { jsx as jsx79 } from "react/jsx-runtime";
var Section = ({ children }) => {
  return /* @__PURE__ */ jsx79(Card3, { children: /* @__PURE__ */ jsx79(CardContent3, { children: /* @__PURE__ */ jsx79(Stack3, { direction: "column", spacing: 2, children }) }) });
};

// src/components/Form/Wizard.tsx
import {
  Card as Card4,
...
import { styled as styled61 } from "@mui/material/styles";
import { useMemo as useMemo5 } from "react";
import { jsx as jsx80, jsxs as jsxs29 } from "react/jsx-runtime";
var StyledWizardActionsStack = styled61(Stack2)(() => ({
  justifyContent: "space-between",
  flexGrow: 1
}));
function Wizard({ steps, activeStep, actions }) {
  const step = useMemo5(() => activeStep < steps.length ? steps[activeStep] : null, [steps, activeStep]);
  return /* @__PURE__ */ jsx80(Card4, { children: /* @__PURE__ */ jsx80(CardContent4, { children: /* @__PURE__ */ jsxs29(Stack2, { children: [
    /* @__PURE__ */ jsx80(Stepper, { activeStep, children: steps.map((step2) => /* @__PURE__ */ jsx80(Step, { children: /* @__PURE__ */ jsx80(StepLabel, { children: step2.label }) }, step2.label)) }),
    /* @__PURE__ */ jsx80(Divider10, {}),
    /* @__PURE__ */ jsx80(Stack2, { direction: "row", children: step == null ? void 0 : step.component }),
    /* @__PURE__ */ jsx80(StyledWizardActionsStack, { direction: "row", children: actions })
  ] }) }) });
}

// src/components/Form/ElementWrapper.tsx
import { FormControl as FormControl3, FormLabel } from "@mui/material";
import { jsx as jsx81, jsxs as jsxs30 } from "react/jsx-runtime";
var ElementWrapper = (props) => {
  const { label, name, children } = props;
  return /* @__PURE__ */ jsxs30(FormControl3, { fullWidth: true, children: [
    /* @__PURE__ */ jsx81(FormLabel, { htmlFor: name, children: label }),
    children
  ] });
};
...
function Layout(_a) {
  var _b = _a, { children = null, sx } = _b, rest = __objRest(_b, ["children", "sx"]);
...
// src/layouts/LayoutSidebar.tsx
import Box32 from "@mui/material/Box";
import { jsx as jsx83 } from "react/jsx-runtime";
function LayoutSidebar(_a) {
  var _b = _a, { children = null, sx } = _b, rest = __objRest(_b, ["children", "sx"]);
...
// src/layouts/LayoutNavbar.tsx
function LayoutNavbar({ children = null }) {
  return children;
}
LayoutNavbar.displayName = "Layout.Navbar";
var LayoutNavbar_default = LayoutNavbar;

// src/layouts/LayoutContent.tsx
import Box33 from "@mui/material/Box";
import { jsx as jsx84 } from "react/jsx-runtime";
function LayoutContent(_a) {
  var _b = _a, { children = null } = _b, rest = __objRest(_b, ["children"]);
...
var LayoutContent_default = LayoutContent;

// src/layouts/LayoutHeader.tsx
import Box34 from "@mui/material/Box";
import { jsx as jsx85 } from "react/jsx-runtime";
function LayoutHeader(_a) {
  var _b = _a, { children = null, sx } = _b, rest = __objRest(_b, ["children", "sx"]);
...
var Layout2 = Object.assign(Layout_default, {
  Sidebar: LayoutSidebar_default,
  Navbar: LayoutNavbar_default,
  Content: LayoutContent_default,
  Header: LayoutHeader_default
});
var layouts_default = Layout2;

// src/components/AppShell/AppShellNavbar.tsx
import { Fragment as Fragment10, jsx as jsx86 } from "react/jsx-runtime";
var AppShellNavbar = ({ children }) => {
  return /* @__PURE__ */ jsx86(Fragment10, { children });
};
AppShellNavbar.displayName = "AppShellNavbar";

// src/components/AppShell/AppShellSidebar.tsx
import { Fragment as Fragment11, jsx as jsx87 } from "react/jsx-runtime";
var AppShellSidebar = ({ children }) => {
  return /* @__PURE__ */ jsx87(Fragment11, { children });
};
AppShellSidebar.displayName = "AppShellSidebar";

// src/components/AppShell/AppShellMain.tsx
import { Fragment as Fragment12, jsx as jsx88 } from "react/jsx-runtime";
var AppShellMain = ({ children }) => {
  return /* @__PURE__ */ jsx88(Fragment12, { children });
};
AppShellMain.displayName = "AppShellMain";

// src/components/AppShell/AppShellFooter.tsx
import { Fragment as Fragment13, jsx as jsx89 } from "react/jsx-runtime";
var AppShellFooter = ({ children }) => {
  return /* @__PURE__ */ jsx89(Fragment13, { children });
};
AppShellFooter.displayName = "AppShellFooter";

// src/components/AppShell/AppShellNotificationPanel.tsx
import { Fragment as Fragment14, jsx as jsx90 } from "react/jsx-runtime";
var AppShellNotificationPanel = ({ children }) => {
  return /* @__PURE__ */ jsx90(Fragment14, { children });
};
AppShellNotificationPanel.displayName = "AppShellNotificationPanel";

// src/hooks/useAppShell/useAppShell.ts
import * as React30 from "react";
import useMediaQuery2 from "@mui/material/useMediaQuery";
var useAppShell = (options) => {
  const contextValue = React30.useContext(AppShellContext);
  const {
  ...
  const isMobile = useMediaQuery2((theme) => theme.breakpoints.down("md"));
  ...
  React30.useEffect(() => {
    if (options && collapseOnMobile && isMobile) {
      setState((prev) => __spreadProps(__spreadValues({}, prev), { sidebarCollapsed: true }));
    }
  }, [options, collapseOnMobile, isMobile]);
  const toggleSidebar = React30.useCallback(() => {
    setState((prev) => __spreadProps(__spreadValues({}, prev), { sidebarCollapsed: !prev.sidebarCollapsed }));
  }, []);
  const setSidebarCollapsed = React30.useCallback((collapsed) => {
    setState((prev) => __spreadProps(__spreadValues({}, prev), { sidebarCollapsed: collapsed }));
  }, []);
  const collapseSidebar = React30.useCallback(() => {
    setState((prev) => __spreadProps(__spreadValues({}, prev), { sidebarCollapsed: true }));
  }, []);
  const expandSidebar = React30.useCallback(() => {
    setState((prev) => __spreadProps(__spreadValues({}, prev), { sidebarCollapsed: false }));
  }, []);
  const toggleNotificationPanel = React30.useCallback(() => {
    setState((prev) => __spreadProps(__spreadValues({}, prev), {
      notificationPanelOpen: !prev.notificationPanelOpen
    }));
  }, []);
  const setActiveMenuItem = React30.useCallback((id) => {
    setState((prev) => {
      const newState = __spreadProps(__spreadValues({}, prev), { activeMenuItem: id });
  ...
  const toggleMenu = React30.useCallback((id) => {
    setState((prev) => __spreadProps(__spreadValues({}, prev), {
      expandedMenus: __spreadProps(__spreadValues({}, prev.expandedMenus), {
        [id]: !prev.expandedMenus[id]
      })
    }));
  }, []);
  const actions = React30.useMemo(
    () => ({
      toggleSidebar,
      setSidebarCollapsed,
      collapseSidebar,
  ...
  const createdValue = React30.useMemo(
    () => ({
      state,
      actions
    }),
...
var AppShell = (_a) => {
  var _b = _a, { children, sx } = _b, shellOptions = __objRest(_b, ["children", "sx"]);
  const shell = useAppShell(shellOptions);
  const slots = extractSlots(children);
  return /* @__PURE__ */ jsx91(AppShellContext.Provider, { value: shell, children: /* @__PURE__ */ jsxs31(layouts_default, { sx: __spreadValues({ height: "100vh", flexDirection: "column" }, sx), children: [
    slots.navbar && /* @__PURE__ */ jsx91(layouts_default.Navbar, { children: slots.navbar }),
    /* @__PURE__ */ jsxs31(layouts_default, { sx: { flex: 1, overflow: "hidden" }, children: [
      slots.sidebar && /* @__PURE__ */ jsx91(layouts_default.Sidebar, { children: slots.sidebar }),
      /* @__PURE__ */ jsxs31(layouts_default.Content, { sx: { flex: 1, display: "flex", flexDirection: "column" }, children: [
        /* @__PURE__ */ jsx91(Box35, { sx: { flex: 1, overflow: "auto", display: "flex" }, children: slots.main }),
        slots.footer
      ] })
    ] }),
...
// src/components/ListingTable/ListingTable/ListingTable.tsx
import MuiTable from "@mui/material/Table";
import { styled as styled67 } from "@mui/material/styles";

// src/components/ListingTable/shared/types.ts
var densityStyles = {
...
// src/components/ListingTable/ListingTable/ListingTableContainer.tsx
import MuiTableContainer from "@mui/material/TableContainer";
import Paper from "@mui/material/Paper";
import { jsx as jsx92 } from "react/jsx-runtime";
function ListingTableContainer(_a) {
  var _b = _a, {
    elevation = 1,
    disablePaper = false,
    children
  ...
  if (disablePaper) {
    return /* @__PURE__ */ jsx92(MuiTableContainer, __spreadProps(__spreadValues({ sx: __spreadValues({ width: "100%" }, props.sx) }, props), { children }));
  }
  return /* @__PURE__ */ jsx92(MuiTableContainer, __spreadProps(__spreadValues({ component: Paper, elevation, sx: __spreadValues({ width: "100%" }, props.sx) }, props), { children }));
}
var ListingTableContainer_default = ListingTableContainer;

// src/components/ListingTable/ListingTable/ListingTableHead.tsx
import MuiTableHead from "@mui/material/TableHead";
import { styled as styled62 } from "@mui/material/styles";
import { jsx as jsx93 } from "react/jsx-runtime";
var StyledTableHead = styled62(MuiTableHead)(({ theme }) => ({
  "& .MuiTableCell-head": __spreadValues(__spreadValues({
    fontWeight: 600
...
function ListingTableHead(_a) {
  var _b = _a, { children } = _b, props = __objRest(_b, ["children"]);
  return /* @__PURE__ */ jsx93(StyledTableHead, __spreadProps(__spreadValues({}, props), { children }));
}
var ListingTableHead_default = ListingTableHead;

// src/components/ListingTable/ListingTable/ListingTableBody.tsx
import MuiTableBody from "@mui/material/TableBody";
import { jsx as jsx94 } from "react/jsx-runtime";
function ListingTableBody(_a) {
  var _b = _a, { children } = _b, props = __objRest(_b, ["children"]);
  return /* @__PURE__ */ jsx94(MuiTableBody, __spreadProps(__spreadValues({}, props), { children }));
}
var ListingTableBody_default = ListingTableBody;

// src/components/ListingTable/ListingTable/ListingTableFooter.tsx
import MuiTableFooter from "@mui/material/TableFooter";
import { jsx as jsx95 } from "react/jsx-runtime";
function ListingTableFooter(_a) {
  var _b = _a, { children } = _b, props = __objRest(_b, ["children"]);
  return /* @__PURE__ */ jsx95(MuiTableFooter, __spreadProps(__spreadValues({}, props), { children }));
}
var ListingTableFooter_default = ListingTableFooter;

// src/components/ListingTable/ListingTable/ListingTableRow.tsx
import MuiTableRow from "@mui/material/TableRow";
import { styled as styled63, alpha } from "@mui/material/styles";
import { jsx as jsx96 } from "react/jsx-runtime";
var StyledTableRow = styled63(MuiTableRow, {
  shouldForwardProp: (prop) => !["clickable", "variant"].includes(prop)
})(({ theme: muiTheme, clickable, variant = "table" }) => {
  const theme = muiTheme;
  const borderRadius = 8;
  const isDarkMode = theme.palette.mode === "dark";
  return __spreadValues(__spreadValues(__spreadValues({}, clickable && {
    cursor: "pointer"
  }), variant === "card" && (() => {
    var _a, _b, _c, _d;
    ...
    return {
      ...
      backgroundColor: (_b = (_a = theme.vars) == null ? void 0 : _a.palette.background.acrylic) != null ? _b : (theme.vars || theme).palette.background.paper,
      backdropFilter: (_c = theme.blur) == null ? void 0 : _c.light,
      WebkitBackdropFilter: (_d = theme.blur) == null ? void 0 : _d.light,
      borderRadius,
      "& .MuiTableCell-root": {
        backgroundColor: "transparent",
...
function ListingTableRow(_a) {
  ...
  return /* @__PURE__ */ jsx96(StyledTableRow, __spreadProps(__spreadValues({ clickable, variant }, props), { children }));
}
var ListingTableRow_default = ListingTableRow;

// src/components/ListingTable/ListingTable/ListingTableCell.tsx
import MuiTableCell from "@mui/material/TableCell";
import { styled as styled64 } from "@mui/material/styles";
import { jsx as jsx97 } from "react/jsx-runtime";
var StyledTableCell = styled64(MuiTableCell, {
  shouldForwardProp: (prop) => {
    const excludedProps = ["truncate", "maxWidth"];
    return !excludedProps.some((excluded) => excluded === prop);
  }
})(({ truncate, maxWidth }) => __spreadValues(__spreadValues({}, truncate && {
  overflow: "hidden",
  textOverflow: "ellipsis",
  whiteSpace: "nowrap"
}), maxWidth && {
...
function ListingTableCell(_a) {
  ...
  return /* @__PURE__ */ jsx97(StyledTableCell, __spreadProps(__spreadValues({ truncate, maxWidth }, props), { children }));
}
var ListingTableCell_default = ListingTableCell;

// src/components/ListingTable/ListingTable/ListingTableDataGrid.tsx
import { useCallback as useCallback2 } from "react";
import { DataGrid } from "@mui/x-data-grid";
import { styled as styled65, alpha as alpha2 } from "@mui/material/styles";

// src/components/ListingTable/context.ts
import * as React32 from "react";
var ListingTableContext = React32.createContext(null);
ListingTableContext.displayName = "ListingTableContext";
var useListingTable = () => {
  return React32.useContext(ListingTableContext);
};
var useListingTableRequired = () => {
  const context = React32.useContext(ListingTableContext);
  if (!context) {
    throw new Error(
      "useListingTableRequired must be used within a ListingTable.Provider. Use useListingTable() for optional context access."
    );
  }
  return context;
};
...
var StyledDataGrid = styled65(DataGrid)(({ theme }) => ({
  ...
  "& .MuiDataGrid-columnHeaders": __spreadValues(__spreadValues({
...
function ListingTableDataGrid(_a) {
  var _b = _a, {
    density: densityProp,
    loading: loadingProp,
  ...
  const density = (_a2 = densityProp != null ? densityProp : context == null ? void 0 : context.density) != null ? _a2 : "standard";
  const loading = loadingProp !== void 0 ? loadingProp : (_b2 = context == null ? void 0 : context.loading) != null ? _b2 : false;
  const variant = (context == null ? void 0 : context.variant) === "data-grid-card" ? "card" : "table";
  const searchValue = (_c = context == null ? void 0 : context.searchValue) != null ? _c : "";
  const filterModel = filterModelProp != null ? filterModelProp : {
    items: [],
    quickFilterValues: searchValue ? [searchValue] : []
  };
  const defaultCardRowSpacing = useCallback2(
    (params) => ({ top: params.isFirstVisible ? 0 : 12, bottom: 0 }),
    []
  );
  const cardSx = (muiTheme) => {
    var _a3, _b3, _c2, _d2;
    return {
      ...
      "& .MuiDataGrid-row": {
        borderRadius: "8px",
        border: "none",
        backgroundColor: (_b3 = (_a3 = muiTheme.vars) == null ? void 0 : _a3.palette.background.acrylic) != null ? _b3 : (muiTheme.vars || muiTheme).palette.background.paper,
        backdropFilter: (_c2 = muiTheme.blur) == null ? void 0 : _c2.light,
        WebkitBackdropFilter: (_d2 = muiTheme.blur) == null ? void 0 : _d2.light,
        "&:hover": {
  ...
  const resolvedDensity = (_d = densityProp != null ? densityProp : context == null ? void 0 : context.density) != null ? _d : "standard";
  ...
  const mergedSx = variant === "card" ? [cardSx, densitySx, ...Array.isArray(sx) ? sx : [sx]] : [densitySx, ...Array.isArray(sx) ? sx : [sx]];
  return /* @__PURE__ */ jsx98(
    ...
    __spreadValues({
      ...
      loading,
      filterModel,
      getRowSpacing: variant === "card" ? getRowSpacingProp != null ? getRowSpacingProp : defaultCardRowSpacing : getRowSpacingProp,
      sx: mergedSx
    }, props)
  );
}
var ListingTableDataGrid_default = ListingTableDataGrid;

// src/components/ListingTable/shared/ListingTableToolbar.tsx
...
import { Search as Search3, X as X4 } from "@wso2/oxygen-ui-icons-react";
import { Fragment as Fragment15, jsx as jsx99, jsxs as jsxs32 } from "react/jsx-runtime";
function ListingTableToolbar({
  showSearch = false,
  searchSlot,
  ...
  const [internalSearchValue, setInternalSearchValue] = useState7("");
  const isControlledByProp = controlledSearchValue !== void 0;
  const isControlledByContext = !isControlledByProp && (tableContext == null ? void 0 : tableContext.searchValue) !== void 0;
  const isControlled = isControlledByProp || isControlledByContext;
  const searchValue = isControlledByProp ? controlledSearchValue : isControlledByContext ? tableContext.searchValue : internalSearchValue;
  const effectiveOnSearchChange = onSearchChange != null ? onSearchChange : tableContext == null ? void 0 : tableContext.onSearchChange;
  const handleSearchChange = useCallback3(
    (event) => {
      ...
      effectiveOnSearchChange == null ? void 0 : effectiveOnSearchChange(newValue);
    },
    [isControlled, effectiveOnSearchChange]
  );
  const handleClearSearch = useCallback3(() => {
    if (!isControlled) {
      setInternalSearchValue("");
    }
    effectiveOnSearchChange == null ? void 0 : effectiveOnSearchChange("");
  }, [isControlled, effectiveOnSearchChange]);
  const renderSearch = () => {
    if (searchSlot) {
      return searchSlot;
    ...
    if (showSearch) {
      return /* @__PURE__ */ jsx99(
        TextField3,
        {
          ...
          InputProps: {
            startAdornment: /* @__PURE__ */ jsx99(InputAdornment3, { position: "start", children: /* @__PURE__ */ jsx99(Search3, { size: 18 }) }),
            endAdornment: searchValue ? /* @__PURE__ */ jsx99(InputAdornment3, { position: "end", children: /* @__PURE__ */ jsx99(IconButton7, { size: "small", onClick: handleClearSearch, edge: "end", children: /* @__PURE__ */ jsx99(X4, { size: 16 }) }) }) : null
          }
        }
      );
    }
  ...
  return /* @__PURE__ */ jsxs32(
    Box36,
    {
      ...
      children: [
        renderSearch(),
        children,
        actions && /* @__PURE__ */ jsxs32(Fragment15, { children: [
          /* @__PURE__ */ jsx99(Box36, { sx: { flex: 1 } }),
          /* @__PURE__ */ jsx99(Box36, { sx: { display: "flex", alignItems: "center", gap: 1 }, children: actions })
        ] })
      ]
    }
  );
}
var ListingTableToolbar_default = ListingTableToolbar;

// src/components/ListingTable/shared/ListingTableEmptyState.tsx
import Box37 from "@mui/material/Box";
import Typography19 from "@mui/material/Typography";
import { jsx as jsx100, jsxs as jsxs33 } from "react/jsx-runtime";
function ListingTableEmptyState({
  ...
  return /* @__PURE__ */ jsxs33(
    Box37,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx100(Typography19, { variant: "h6", component: "div", sx: { mb: description ? 1 : 0, fontWeight: 500 }, children: title }),
        description && /* @__PURE__ */ jsx100(Typography19, { variant: "body2", color: "text.secondary", sx: { mb: action ? 2 : 0, maxWidth: 400 }, children: description }),
        action && /* @__PURE__ */ jsx100(Box37, { children: action })
      ]
    }
  );
}
var ListingTableEmptyState_default = ListingTableEmptyState;

// src/components/ListingTable/shared/ListingTableDensityControl.tsx
import { useCallback as useCallback4 } from "react";
import ToggleButton from "@mui/material/ToggleButton";
import ToggleButtonGroup from "@mui/material/ToggleButtonGroup";
import Tooltip6 from "@mui/material/Tooltip";
import { AlignJustify, Menu as Menu3, List as List4 } from "@wso2/oxygen-ui-icons-react";
import { jsx as jsx101 } from "react/jsx-runtime";
var densityOptions = [
  { value: "compact", label: "Compact", icon: /* @__PURE__ */ jsx101(AlignJustify, { size: 18 }) },
  { value: "standard", label: "Standard", icon: /* @__PURE__ */ jsx101(Menu3, { size: 18 }) },
  { value: "comfortable", label: "Comfortable", icon: /* @__PURE__ */ jsx101(List4, { size: 18 }) }
];
function ListingTableDensityControl({
  value: valueProp,
  ...
  var _a;
  const tableContext = useListingTable();
  const value = (_a = valueProp != null ? valueProp : tableContext == null ? void 0 : tableContext.density) != null ? _a : "standard";
  const effectiveOnChange = onChangeProp != null ? onChangeProp : tableContext == null ? void 0 : tableContext.onDensityChange;
  const handleChange = useCallback4(
    (_event, newDensity) => {
      if (newDensity !== null) {
        effectiveOnChange == null ? void 0 : effectiveOnChange(newDensity);
      }
    },
    [effectiveOnChange]
  );
  return /* @__PURE__ */ jsx101(ToggleButtonGroup, { value, exclusive: true, onChange: handleChange, size, sx, children: densityOptions.map((option) => /* @__PURE__ */ jsx101(ToggleButton, { value: option.value, children: /* @__PURE__ */ jsx101(Tooltip6, { title: option.label, children: /* @__PURE__ */ jsx101("span", { style: { display: "flex", alignItems: "center" }, children: option.icon }) }) }, option.value)) });
}
var ListingTableDensityControl_default = ListingTableDensityControl;

// src/components/ListingTable/shared/ListingTableSortLabel.tsx
import { useCallback as useCallback5 } from "react";
import MuiTableSortLabel from "@mui/material/TableSortLabel";
import { styled as styled66 } from "@mui/material/styles";
import { jsx as jsx102 } from "react/jsx-runtime";
var StyledTableSortLabel = styled66(MuiTableSortLabel)(({ theme }) => ({
...
function ListingTableSortLabel(_a) {
  var _b = _a, {
    field,
    active: activeProp,
  ...
  var _a2;
  const tableContext = useListingTable();
  const isActiveFromContext = field !== void 0 && (tableContext == null ? void 0 : tableContext.sortField) === field;
  const active = activeProp != null ? activeProp : isActiveFromContext;
  const direction = (_a2 = directionProp != null ? directionProp : isActiveFromContext ? tableContext == null ? void 0 : tableContext.sortDirection : void 0) != null ? _a2 : "asc";
  const handleClick = useCallback5(
    (event) => {
      ...
      if (field && (tableContext == null ? void 0 : tableContext.onSortChange)) {
  ...
  return /* @__PURE__ */ jsx102(StyledTableSortLabel, __spreadProps(__spreadValues({ active, direction, onClick: handleClick, hideSortIcon }, props), { children }));
}
var ListingTableSortLabel_default = ListingTableSortLabel;

// src/components/ListingTable/shared/ListingTableRowActions.tsx
...
function ListingTableRowActions({
  children,
  visibility = "always",
  align = "right",
  sx
...
var ListingTableRowActions_default = ListingTableRowActions;

// src/components/ListingTable/shared/ListingTableCellIcon.tsx
import Box39 from "@mui/material/Box";
import Typography20 from "@mui/material/Typography";
import { Fragment as Fragment16, jsx as jsx104, jsxs as jsxs34 } from "react/jsx-runtime";
function ListingTableCellIcon({
  icon,
  primary,
  secondary,
  iconPosition = "left",
  ...
  const iconElement = /* @__PURE__ */ jsx104(
    Box39,
    {
      sx: __spreadValues({
        display: "flex",
  ...
  const textContent = /* @__PURE__ */ jsxs34(Box39, { sx: { minWidth: 0, flex: 1 }, children: [
    /* @__PURE__ */ jsx104(
      Typography20,
      {
        variant: "body2",
  ...
  return /* @__PURE__ */ jsx104(
    Box39,
    {
      ...
      children: iconPosition === "left" ? /* @__PURE__ */ jsxs34(Fragment16, { children: [
        iconElement,
        textContent
      ] }) : /* @__PURE__ */ jsxs34(Fragment16, { children: [
        textContent,
        iconElement
      ] })
    }
...
var ListingTableCellIcon_default = ListingTableCellIcon;

// src/components/ListingTable/ListingTableProvider.tsx
import { useMemo as useMemo7 } from "react";
import { jsx as jsx105 } from "react/jsx-runtime";
function ListingTableProvider({
  children,
  // Search
  searchValue,
  onSearchChange,
  ...
  return /* @__PURE__ */ jsx105(ListingTableContext.Provider, { value: contextValue, children });
}

// src/components/ListingTable/ListingTable/ListingTable.tsx
import { jsx as jsx106 } from "react/jsx-runtime";
var StyledTable = styled67(MuiTable, {
  shouldForwardProp: (prop) => {
    const excludedProps = ["variant", "density", "striped", "bordered"];
    return !excludedProps.some((excluded) => excluded === prop);
  }
})(({ theme, variant = "table", density = "standard", striped, bordered }) => __spreadValues(__spreadProps(__spreadValues({}, variant === "card" && {
  ...
  "& .MuiTableHead-root .MuiTableCell-root.MuiTableCell-head": __spreadValues(__spreadValues({
    backgroundColor: "transparent",
    borderBottom: "none",
    fontWeight: 600,
  ...
  "& .MuiTableCell-root": __spreadValues({
    padding: densityStyles[density].padding
  }, bordered && variant === "table" && {
    borderRight: `1px solid ${theme.palette.divider}`,
    "&:last-child": {
      borderRight: "none"
    }
  })
}), striped && variant === "table" && {
  "& .MuiTableBody-root .MuiTableRow-root:nth-of-type(odd)": {
    backgroundColor: theme.palette.action.hover
  }
}));
function ListingTable(_a) {
  var _b = _a, {
    variant = "table",
    density = "standard",
    striped = false,
...
var ListingTableCompound = Object.assign(ListingTable, {
  Provider: ListingTableProvider,
  Container: ListingTableContainer_default,
  Head: ListingTableHead_default,
  Body: ListingTableBody_default,
  Footer: ListingTableFooter_default,
  Row: ListingTableRow_default,
  Cell: ListingTableCell_default,
  CellIcon: ListingTableCellIcon_default,
  RowActions: ListingTableRowActions_default,
  EmptyState: ListingTableEmptyState_default,
  Toolbar: ListingTableToolbar_default,
  SortLabel: ListingTableSortLabel_default,
  DensityControl: ListingTableDensityControl_default,
  DataGrid: ListingTableDataGrid_default
});
var ListingTable_default = ListingTableCompound;

// src/animations/ParticleBackground/ParticleBackground.tsx
import { useEffect as useEffect5, useRef } from "react";
import { useColorScheme as useColorScheme3 } from "@mui/material/styles";
...
var ParticleBackground = ({
  ...
  useEffect5(() => {
    ...
    function computeParticlesCount() {
      ...
      targetCount = Math.round(baseDensity * (area / 1e4));
      ...
      for (let i = 0; i < particles.length; i++) {
        for (let j = i + 1; j < particles.length; j++) {
          ...
          if (dist < linkDist * DPR) {
            const alpha3 = linkAlpha * (1 - dist / (linkDist * DPR));
...
// src/hooks/useThemeContent/useThemeContent.ts
function useThemeContent(contentMap, fallback) {
  var _a, _b;
  const { currentTheme } = useThemeSwitcher();
  return (_b = (_a = contentMap[currentTheme]) != null ? _a : fallback) != null ? _b : Object.values(contentMap)[0];
}
var useThemeContent_default = useThemeContent;

// src/hooks/useNotifications/useNotifications.ts
...
var useNotifications = (options = {}) => {
  ...
  const [notifications, setNotifications] = React33.useState(
    initialNotifications
  );
  const markRead = React33.useCallback((id) => {
    setNotifications(
      (prev) => prev.map((n) => n.id === id ? __spreadProps(__spreadValues({}, n), { read: true }) : n)
    );
  }, []);
  const dismiss = React33.useCallback((id) => {
    setNotifications((prev) => prev.filter((n) => n.id !== id));
  }, []);
  const markAllRead = React33.useCallback(() => {
    setNotifications((prev) => prev.map((n) => __spreadProps(__spreadValues({}, n), { read: true })));
  }, []);
  const clearAll = React33.useCallback(() => {
    setNotifications([]);
  }, []);
  const add = React33.useCallback((notification) => {
    const newNotification = __spreadProps(__spreadValues({}, notification), {
      id: generateId()
    });
    setNotifications((prev) => [newNotification, ...prev]);
  }, []);
  const unreadCount = React33.useMemo(
    () => notifications.filter((n) => !n.read).length,
    [notifications]
  );
  const unreadNotifications = React33.useMemo(
...
import * as DataGrid2 from "@mui/x-data-grid";
import * as DatePickers from "@mui/x-date-pickers";
import { AdapterDateFns } from "@mui/x-date-pickers/AdapterDateFns";
import * as TreeView from "@mui/x-tree-view";
var version = package_default.version;
export {
  AcrylicOrangeTheme_default as AcrylicOrangeTheme,
  AcrylicPurpleTheme_default as AcrylicPurpleTheme,
  AdapterDateFns,
  AppShell,
  ChoreoTheme_default as ChoreoTheme,
  ClassicTheme_default as ClassicTheme,
  CodeBlock_default as CodeBlock,
  ColorSchemeImage,
  ColorSchemeToggle,
  ColorSchemeToggle_default as ColorSchemeToggleDefault,
  ComplexSelect_default as ComplexSelect,
  DataGrid2 as DataGrid,
  DatePickers,
  Footer,
  Form,
  Header,
  HighContrastTheme_default as HighContrastTheme,
  layouts_default as Layout,
  ListingTable_default as ListingTable,
  ListingTableContext,
  ListingTableProvider,
  NotificationBanner,
  NotificationPanel,
  AcrylicBaseTheme_default as OxygenTheme,
  OxygenUIThemeProvider,
  PageContent_default as PageContent,
  PageTitle_default as PageTitle,
  PaleBaseTheme_default as PaleBaseTheme,
  PaleGray_default as PaleGrayTheme,
  PaleIndigo_default as PaleIndigoTheme,
  ParticleBackground,
  SearchBar_default as SearchBar,
  SearchBarWithAdvancedFilter_default as SearchBarWithAdvancedFilter,
  Sidebar,
  ...
  useNotifications,
  useThemeContent,
  useThemeContent_default as useThemeContentDefault,
  useThemeSwitcher,
  version
};
