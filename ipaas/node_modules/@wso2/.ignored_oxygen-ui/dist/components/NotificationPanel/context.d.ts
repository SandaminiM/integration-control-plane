 ...
 */
export declare const NotificationPanelContext: React.Context<NotificationPanelContextValue | null>;
/**
 * Hook to access NotificationPanel context.
 * @throws Error if used outside NotificationPanel
 */
export declare const useNotificationPanel: () => NotificationPanelContextValue;
