 ...
 */
export declare const SidebarItemContext: React.Context<SidebarItemContextValue | null>;
/**
 * Hook to access the sidebar item context.
 * Must be used within a SidebarItem component.
 */
export declare const useSidebarItemContext: () => SidebarItemContextValue;
/**
 * Provider component for sidebar item context.
 */
export declare const SidebarItemProvider: React.FC<{
