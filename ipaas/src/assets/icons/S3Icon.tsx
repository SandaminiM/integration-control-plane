...
/** AWS S3 brand icon (Amazon Architecture Icon set). */
export default function S3Icon({ size = 24 }: { size?: number }): JSX.Element {
  const gradientId = useId();
  return (
    <svg height={size} width={size} viewBox="0 0 80 80" aria-hidden="true">
      <defs>
      ...
      <g fill="none" fillRule="evenodd">
        <rect x="0" y="0" width="80" height="80" fill={`url(#${gradientId})`} />
