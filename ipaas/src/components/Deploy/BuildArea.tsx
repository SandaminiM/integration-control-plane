...
export default function BuildArea({
  ...
  return (
    <>
      ...
      {!flags.isAutomation && !hideEndpoints && !!firstEnvReleaseId && <EndpointConfigDrawer open={endpointConfigOpen} onClose={() => setEndpointConfigOpen(false)} componentId={componentId} versionId={versionId} firstEnvReleaseId={firstEnvReleaseId} firstEnvId={firstEnvId} />}
