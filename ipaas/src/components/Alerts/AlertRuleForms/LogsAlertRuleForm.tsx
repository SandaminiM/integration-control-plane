...
import { ALERT_CREATE_NEW_RULE_ADVANCED_TITLE, ALERT_RULE_LOG_SEARCH_PHRASE_MAX_LENGTH, ALERT_RULE_THRESHOLD_MAX, ALERT_RULE_THRESHOLD_MIN, AlertRulePeriodConstants, type AlertRulePeriodOption, type AlertRulePeriod } from '../../../constants/alerts';
