...
const ni = (name: string): never => {
  throw new Error(`[icp] customDomains.${name}: not implemented`);
};
...
export const createUrlMapping = (_input: CreateUrlMappingInput): Promise<CustomUrlMapping> => ni('createUrlMapping');
export const updateUrlMapping = (_urlId: string, _input: CreateUrlMappingInput): Promise<CustomUrlMapping> => ni('updateUrlMapping');
export const deleteUrlMapping = (_urlId: string): Promise<void> => ni('deleteUrlMapping');
