...
const ni = (name: string): never => {
  throw new Error(`[icp] externalCi.${name}: not implemented`);
};
...
export const revokeExternalCiToken = (_orgUuid: string, _projectId: string, _componentId: string, _tokenId: string): Promise<void> => ni('revokeExternalCiToken');
