...
export default function Signup(): JSX.Element {
  ...
  const handleEmailSignup = () => {
    ...
    const postRegisterCallback = encodeURIComponent(`${origin}/login?method=basic&returnToUrl=%2F`);
      ...
      <Grid container sx={{ flex: 1 }}>
        ...
        <Grid
          ...
          <Box
            ...
            <img src={`${base}assets/images/WIP-login.svg`} alt="Sign up illustration" style={{ maxWidth: '90%', maxHeight: '280px', objectFit: 'contain' }} />
          </Box>
        </Grid>
